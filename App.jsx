...
const T = {
  en: {
    ...
    onboarding: {
      q1:"How old are you?", q2:"How much do you currently have invested? (€)", q3:"How much do you save per month? (€)",
      q4:"What is your monthly income after tax? (€)", q5:"Which country are you in?", q6:"What is your FIRE goal?",
      hints: { age:"Your current age", portfolio:"Total invested in ETFs, stocks, etc. Enter 0 if you're just starting.", savings:"How much you invest every month", income:"Your take-home pay after taxes" },
      countries: { austria:"🇦🇹 Austria", germany:"🇩🇪 Germany", switzerland:"🇨🇭 Switzerland", other:"🌍 Other" },
    },
    share: "Share My Plan",
    copied: "Link copied!",
    langToggle: "DE",
    // ── UI primitives ──────────────────────────────────────────────────────────
    ui: {
      back:"← Back", continue:"Continue →", skip:"Skip — use example data", close:"✕ close",
      remove:"Remove", add:"+ Add", on:"ON", off:"OFF", portfolioOnly:"Portfolio only",
      now:"Now!", done:"Done", yearsAway:"yrs away", ageLabel:"Age", priority:"PRIORITY",
      fireNow:"🎯 FIRE!", diminishing:"⚠️ Diminishing", worthIt:"✅ Worth it",
    },
    // ── Fire types ──────────────────────────────────────────────────────────────
    fireTypes: {
    ...
    // ── Export/Import modal ─────────────────────────────────────────────────────
    exportModal: {
      title:"📤 Export / Import Your Plan",
      howToShare:"💡 How to share:",
      howToShareDesc:"Copy the text below and send it via WhatsApp, email, or any message. Your friend pastes it into the Import box on their device to load your exact plan.",
      planDataLabel:"Your Plan Data (copy everything)",
      copyBtn:"📋 Copy Plan to Clipboard",
      importLabel:"Import a Plan (paste here)",
      importPlaceholder:"Paste your friend's plan data here...",
      loadBtn:"⬇️ Load This Plan",
      invalidData:"Invalid plan data. Please paste the full exported text.",
      resetLabel:"Reset",
    },
    // ── FIRE 101 ────────────────────────────────────────────────────────────────
    learn: {
      title:"FIRE 101 — Everything You Need to Know",
      sub:"No jargon. Simple explanations. Start here.",
      typesTitle:"The 8 Types of FIRE — Pick Your Flavour",
      yourMode:"◀ Your current mode",
      readyMsg:"🚀 You're already on the path.",
      concepts: {
        fourPct: {
          title:"The 4% Rule",
          body:"Research (Trinity Study) shows that if you withdraw 4% of your portfolio per year, it will last 30+ years through almost any historical market. Your FIRE Number = Annual Spending × 25.\n\nExample: €1,300/month = €15,600/year → €15,600 × 25 = €390,000 needed.\n\nWith 'Die with Zero', we use ×20 (5% SWR). With 'Leave Legacy', we use ×30 (3.3% SWR).",
        },
        compound: {
          title:"Compound Interest — The 8th Wonder",
          body:"Your returns earn returns. €10,000 at 7%/year becomes €20,000 in ~10 years — without adding anything. By year 20 it's €40,000. By year 30, €76,000. This is why starting early is the most powerful thing you can do.",
        },
        sorr: {
          title:"Sequence of Returns Risk",
          body:"The order of market returns matters as much as the average. A crash in your first year of retirement is much worse than a crash in year 20. Why? Because you're selling investments at low prices to cover living costs.\n\nAntidote: (1) Keep 2 years of cash, (2) Barista FIRE lets you avoid selling in crashes, (3) flexible spending.",
          highlight:"Same average return, different order = wildly different outcomes. See the Withdrawal tab.",
        },
        coast: { title:"Coast FIRE — The Hidden Milestone" },
      },
    },
    // ── Overview ────────────────────────────────────────────────────────────────
    overview: {
      ...
      sliders: {
        savings:"Monthly savings", portfolio:"Current portfolio", age:"Your age",
        ret:"Expected annual return", sideIncome:"Annual side income (plasma, bonus etc.)",
        creep:"Lifestyle creep — annual spending growth",
      },
      hints: {
        ret:"VWCE/MSCI World historically ~7–9% nominal",
        creep:"Your spending increases by this % every year during accumulation (career progression, family, etc.)",
        sideIncome:"€{v}/yr",
      },
      bonus: {
        title:"🎁 Austrian special payments:",
        both:"Both 13th (Weihnachtsgeld) and 14th (Urlaubsgeld) pay included.",
        thirteenth:"13th pay (Weihnachtsgeld) included.",
        fourteenth:"14th pay (Urlaubsgeld) included.",
        suffix:"Each adds ~{amount} extra savings/year (at 6% flat tax rate on first €2,100). Total bonus savings:",
      },
      fiScore: {
        title:"FI Score",
        tip:"Combines portfolio progress (50pts), savings rate (20pts), and timeline efficiency (20pts). 100 = you're done!",
      },
    },
    // ── Projection ──────────────────────────────────────────────────────────────
    projection: {
      chartTitle:"Portfolio Growth Projection",
      chartTip:"Your projected portfolio value assuming {ret}% annual return. Dashed lines = your milestone targets. Green shaded zone = Barista Phase (work optional → full freedom).",
      baristaPhaseLabel:"☕ Barista Phase",
      baristaPhaseDesc:"Work optional, portfolio covers {gap}+ /mo gap",
      subTabs: { forecast:"📈 Forecast", crisis:"⚠️ Crisis Test" },
      crisis: {
        selectLabel:"Select crisis scenario:",
        triggerLabel:"Crisis trigger year:",
        mitigationTitle:"🛡️ How to Survive Any Crisis — Mitigation Checklist",
        items: [
          { icon:"💵", title:"2-Year Cash Buffer",                   impact:"★★★★★ Most important" },
          { icon:"☕", title:"Barista FIRE as a Backstop",           impact:"★★★★☆ Very effective" },
          { icon:"📉", title:"Dynamic Spending (GK Guardrails)",     impact:"★★★★☆ Proven method" },
          { icon:"🌍", title:"Geo-Arbitrage Escape Valve",           impact:"★★★☆☆ Flexible option" },
          { icon:"🎯", title:"Bigger Portfolio (OMY)",               impact:"★★★☆☆ Diminishing returns" },
        ],
      },
    },
    // ── FIRE Calc ───────────────────────────────────────────────────────────────
    fireCalc: {
      ...
      tip:"Your FIRE Number depends on spending AND the multiplier. 'Die with Zero' = ×20 (5% withdrawal). 'Leave Legacy' = ×30 (3.3%). Classic = ×25 (4%).",
      spendingLabel:"Monthly spending target",
      spendingHint:"Use the Budget tab to calculate your real number",
      modes: { zero:"Die with Zero", classic:"Classic 4%", legacy:"Leave Legacy" },
      boxes: {
        fireNumber:"FIRE Number", monthlyPassive:"Monthly passive", atTarget:"at target",
        fireYear:"FIRE Year", progress:"Progress", ofTheWayThere:"of the way there",
      },
      barista: {
        title:"☕ Barista FIRE",
        tip:"Part-time income + portfolio withdrawal = full monthly coverage. Dynamic target: (Spending − Barista Income) × 12 × (100/SWR).",
        incomeLabel:"Part-time monthly income",
        wageLabel:"Hourly wage (for work-hours calc)",
        wageHint:"Used to calculate how many hours/week you need to sustain Barista FIRE",
        gapLabel:"Portfolio gap/mo", gapSub:"portfolio must cover",
        targetLabel:"Barista target", yearLabel:"Barista year",
        vsFireLabel:"vs Full FIRE", timeSaved:"time saved",
        workLifeTitle:"☕ Barista Work-Life Calculator",
        hrsNeeded:"HRS/WEEK NEEDED", vsFullTime:"vs 40 hrs full-time",
        freeTimeLabel:"FREE TIME", hrsRecovered:"hrs/wk recovered", ofFullTime:"% of full-time",
        monthlyIncomeLabel:"MONTHLY INCOME", grossPerMonth:"/month gross", targetApprox:"≈ target",
        coverageTitle:"Monthly Budget Coverage Breakdown",
        workIncomeLabel:"🍵 Work income:", portShareLabel:"💼 Portfolio:",
        workTag:"🍵 Work", portTag:"💼 Portfolio", totalCovered:"Total covered:",
        advantage:"☕ The Barista FIRE advantage:",
        instead:"Instead of needing", saving:"a saving of",
        working:"Working just", hrsAt:"hrs/week at", gives:"gives you",
        freedomSuffix:"hours of freedom per week while keeping finances fully sustainable.",
      },
      omy: {
        title:"⏰ One More Year (OMY) Analysis",
        tip:"Should you work one more year before retiring? This tool shows the exact safety improvement — and when the returns become so marginal it's not worth delaying freedom.",
        syndrome:"💭 One More Year Syndrome",
        syndromeDesc:"is one of the biggest FIRE traps. Each extra year of work feels like it makes you 'safer' — but the marginal benefit drops sharply after the first 1–2 years. This tool quantifies exactly what each extra year buys you.",
        headers: { extra:"Extra Years", portfolio:"Portfolio at FIRE", failRate:"40yr Fail Rate", improvement:"Improvement", marginal:"Marginal Gain", verdict:"Verdict" },
        baseline:"baseline", lessRisk:"% less risk",
        insight:"📊 Key insight: The biggest risk reduction comes from Year 0→1",
        tradingLife:"At some point, working more just trades your life for marginal statistics.",
      },
    },
    // ── Compare ─────────────────────────────────────────────────────────────────
    compare: {
      title:"FIRE Type Timeline Comparison",
      tip:"See exactly when you'd reach each type of FIRE based on your current parameters. Adjust spending mode and savings to see the impact instantly.",
      headers: { type:"FIRE Type", spend:"Monthly Spend", target:"Target", year:"Year", age:"Age", yearsAway:"Years Away", status:"Status" },
      doneNow:"✅ Now!", done:"Done",
    },
    // ── Withdrawal ──────────────────────────────────────────────────────────────
    withdrawal: {
      failureRates: {
        title:"Portfolio Failure Rates",
        swrLabel:"SWR assumption",
        safe:"🟢 Safe", ok:"🟡 OK", caution:"🟠 Caution", risky:"🔴 Risky",
        safetyValve: {
          title:"☕ Safety Valve Toggle",
          desc:"Show effect of working +5 hrs/wk during a crash",
          suffix:"This reduces your effective withdrawal, dropping failure risk in every horizon above.",
          baristaBeats:"This is why Barista FIRE beats traditional FIRE on safety.",
        },
      },
      sorr: {
        title:"Sequence of Returns Risk",
        warning:"⚠️ Both scenarios below have the same average return (~7%) but completely different outcomes due to timing of returns.",
        lucky:"Lucky (Good Start)", unlucky:"Unlucky (Bad Start)",
      },
      gk: {
        title:"🛡️ Guyton-Klinger Guardrails — Dynamic Spending",
        tip:"Instead of a rigid 4% withdrawal, Guyton-Klinger lets you spend MORE in good years and LESS in bad years. Two rules: Capital Preservation (if SWR breaches 6%, cut spending 10%) and Prosperity (if portfolio grew 20%+ and SWR is low, raise spending 10%). Floor and ceiling keep you safe.",
        infoBox:"💡 How it works: Your spending is alive. Markets up 20%? Treat yourself — spending rises 10%. Withdrawal rate dangerously high? Cut dining-out by 10%. The result: a far more resilient retirement that survives almost any historical sequence of returns.",
        floorLabel:"Spending floor (% of target)", floorHint:"The minimum you're willing to live on — ever",
        ceilLabel:"Spending ceiling (% of target)", ceilHint:"The maximum you'll let yourself spend — the luxury cap",
        boxes: {
          floor:"Spending floor", floorSub:"/month minimum",
          base:"Base spending", baseSub:"/month target",
          ceil:"Spending ceiling", ceilSub:"/month maximum",
          vs:"vs Fixed SWR", vsSub:"historically proven",
        },
        chartDesc:"Portfolio trajectory over 40 years — GK vs Fixed 4% (using a realistic historical return sequence)",
        legends: { gk:"GK Portfolio", fixed:"Fixed 4% Portfolio (dashed)", spend:"GK Monthly Spend (right axis)" },
        why:"🛡️ Why Guardrails beat Fixed 4%:",
        whyDesc:"Historical research (Guyton & Klinger, 2006) shows that adding these two rules raises sustainable withdrawal rates to 5–6% while reducing failure rates. The key insight: a small spending adjustment of 10% in bad years prevents portfolio collapse — preserving 90%+ of your planned lifestyle.",
      },
    },
    // ── Budget ──────────────────────────────────────────────────────────────────
    budget: {
      title:"Monthly Expense Calculator",
      tip:"Enter your actual monthly expenses to calculate your real spending number. This feeds directly into your FIRE calculation.",
      categoryPlaceholder:"Category name", amountPlaceholder:"€/mo",
      totalLabel:"Total Monthly Expenses", annual:"Annual", fireTarget:"FIRE Target (×{mult})", fireYearLabel:"FIRE Year",
      useBudgetLabel:"Use this budget as FIRE spending",
      useBudgetActive:"✅ Budget is driving all FIRE calculations",
      overrideInfo:"💡 Budget override active: €{amount}/mo overrides the \"{mode}\" preset. Your new FIRE target is {target}. All tabs, projections and withdrawal calculations now use this number.",
    },
    // ── Travel ──────────────────────────────────────────────────────────────────
    travel: {
      title:"Travel Calculator",
      budgetLabel:"Monthly travel allocation",
      styleLabel:"Travel style",
      styles: { budget:"Budget", standard:"Standard", comfort:"Comfort" },
      tooLow:"⚠️ Budget too low for a meaningful trip here at {style} level",
      fullMonth:"🎉 Full month+ trip possible!",
      baseSelf:"🌟 You could basically base yourself here part of the year!",
      nomadTitle:"🌍 Nomad FIRE Deep Dive",
      comfortableLifestyle:"comfortable lifestyle",
      daysLabel:"days",
      weeksLabel:"weeks/yr",
    },
    // ── Life ────────────────────────────────────────────────────────────────────
    life: {
      eventTitle:"Life Event Modeller",
      noEvents:"No life events added yet. Add below.",
      evtPlaceholder:"🏠 Event name",
      yearPlaceholder:"Year",
      costPlaceholder:"Cost €",
      coupleTitle:"👫 Couple Mode",
      enableCouple:"Enable Couple Mode",
      partnerSavings:"Partner's monthly savings",
      partnerPortfolio:"Partner's current portfolio",
      combinedPortfolio:"Combined portfolio",
      combinedSavings:"Combined savings/mo",
      combinedFireYear:"Combined FIRE year",
      coupleInfo:"💡 With two incomes, you reach FIRE much faster. One partner can retire first while the other continues — keeping health insurance active for both.",
      ptTitle:"Part-Time Transition Roadmap",
      ptFull:"Full-time Work",
      pt4d:"4 days/week", pt3d:"3 days/week",
      ptBarista:"Barista (2 days)",
      ptFire:"🎯 Full FIRE",
    ...
    // ── Austria ──────────────────────────────────────────────────────────────────
    austria: {
      overviewBox:"🇦🇹 Austrian FIRE Advantages Overview — Austria has surprisingly powerful FIRE advantages: Regelbesteuerungsoption (0% KeSt at low income), SV refunds, Wohnbauförderung housing subsidies, and a solid public pension.",
      gering: {
        title:"Geringfügigkeitsgrenze — The Magic SV Threshold",
        tip:"Under €551.10/month = no social security contributions. Perfect for Barista FIRE.",
        incomeLabel:"Planned monthly income",
        statusUnder:"✅ Under limit", statusOver:"⚠️ Over limit",
        svNotRequired:"No SV required!", svApplies:"SV contributions apply",
        svSavingLabel:"SV saving", vsFullEmp:"vs full employment",
        annualSavingLabel:"Annual saving", perYear:"per year",
      },
      baristaCard: {
        title:"☕ Geringfügige Beschäftigung — Barista FIRE's Secret Weapon",
        tip:"Earning just below €518.44/mo gives you health insurance + social security at near-zero cost. This is the most efficient legal working arrangement for Barista FIRE in Austria.",
        baristaTargetLabel:"BARISTA TARGET",
        idealWageLabel:"IDEAL BARISTA WAGE", stayUnder:"Stay under threshold",
        kvCostLabel:"KV COST (§19a)", kvPerMonth:"/month opt-in",
        savingsVsLabel:"SAVINGS VS PRIVATIER", perYearSaved:"/year saved",
        regelTitle:"🎯 Regelbesteuerungsoption for Barista FIRE Workers",
      },
    },
    // ── Real Estate ─────────────────────────────────────────────────────────────
    re: {
      title:"Real Estate Simulator",
      modeOwn:"🏠 Own Home", modeInvest:"💼 Buy-to-Let Investment",
      ...
      appreciation:"Annual Property Appreciation",
      netWorthProp:"Net Worth (With Property)", netWorthEtf:"Net Worth (ETF Only)",
      equity:"Home Equity", etfPortfolio:"ETF Portfolio",
      ...
      // Mode selector
      modes: {
        none: { label:"🚫 No Property",       desc:"Currently renting. All savings go into ETFs." },
        own:  { label:"🏠 Buy — Own Home",     desc:"Buy your primary residence. Lower FIRE number once mortgage-free." },
        invest:{ label:"💼 Buy — Invest/Let",  desc:"Buy-to-let. Rental income covers mortgage and generates cashflow." },
        inherit:{ label:"🎁 Inherit Property", desc:"Receive a property without purchase cost. Instant equity boost." },
        build: { label:"🏗️ Self-Build",        desc:"Build your own home. Higher upfront work, potentially lower cost/m²." },
      },
      // Inherit mode
      inheritTitle:"🎁 Inherited Property Simulator",
      inheritValueLabel:"Inherited property value",
      inheritValueSub:"current market value",
      inheritValue20ySub:"at {pct}%/yr",
      housingBenefitSub:"vs continuing to rent",
      targetReducLabel:"FIRE target reduction", targetReducSub:"lower FIRE number",
      adjFireYearLabel:"Adjusted FIRE year", adjFireYearSub:"with inheritance",
      vsStandardLabel:"vs standard FIRE", vsStandardSub:"yrs earlier",
      inheritTip:"Once your mortgage is paid off, your housing cost drops to maintenance only — reducing your FIRE number automatically.",
      investTip:"Rental income minus mortgage and costs = your monthly cashflow. This can be reinvested or used to reach FIRE sooner.",
      // Build mode
      buildTitle:"🏗️ Self-Build Simulator",
      buildLandLabel:"Land purchase cost", buildLandHint:"Grundstück — buy land now, build later",
      buildCostLabel:"Construction cost (Baukosten)", buildCostHint:"Austria: ~€1,500–2,500/m² depending on standard",
      buildYearLabel:"Build completion year",
      totalCostLabel:"Total project cost", totalCostSub:"land + build",
      benchmarkLabel:"vs buying equivalent", benchmarkSub:"market price benchmark",
      potSavingLabel:"Potential saving", potSavingSub:"vs market buy",
      monthlyMortgLabel:"Monthly mortgage", monthlyMortgSub:"/month after build",
      completionYearLabel:"Completion year", mortgageFreeLabel:"Mortgage free",
      // Mortgage summary
      mortgageTitle:"📊 Mortgage Summary",
      // FIRE impact
      fireImpactStandard:"Standard FIRE target",
      fireImpactBenefit:"Housing benefit post-payoff", fireImpactBenefitSub:"saved vs renting",
      fireImpactAdj:"Adjusted FIRE target",
      fireImpactStdYear:"FIRE year (standard)", fireImpactWithProp:"FIRE year (with property)",
      fireImpactDiff:"Difference",
      // Buy-to-let
      btlTitle:"🎯 Buy-to-Let FIRE Acceleration",
      btlCashflowMo:"Monthly net cashflow", btlCashflowYr:"Annual net cashflow",
      btlFireStd:"FIRE year (standard)", btlFireWith:"FIRE year (with cashflow)",
      btlGross:"Gross yield", btlNet:"Net yield",
      rentHintChange:"Used to calculate your real monthly cost change",
      rentHintInherit:"Rent you pay now (stops when you inherit)",
      buyVsRentTitle:"Buy vs. Rent — 35-Year Net Worth",
      loanTermYrsLabel:"years",
    },
    // ── Tax Optimizer ────────────────────────────────────────────────────────────
    taxoptimizer: {
      boxes: {
        gross30:"Gross Portfolio (yr 30)", gross30Sub:"no tax considered",
        afterDrag:"After Annual Tax Drag", afterDragSub:"accumulating ETF, annual KeSt",
        spendable:"Real Spendable", spendableSub:"after exit tax on unrealised gain",
        totalTax:"Total Tax Cost", totalTaxSub:"over 30 years",
        taxPct:"Tax as % of Gross", taxPctSub:"of your wealth",
        strategy:"Strategy", strategySub:"current mode",
      },
      strategies: { zero:"0% KeSt 🎉", harvesting:"Harvesting ♻️", standard:"Standard" },
      dragTitle:"📉 Tax Drag — 30-Year Wealth Erosion Visualised",
      dragLegend: { gross:"Gross (no tax)", afterDrag:"After Annual Tax Drag", spendable:"Real Spendable (after exit tax)" },
      regelTitle:"🎯 Regelbesteuerungsoption — The Austrian 0% Tax Strategy",
      regelHowTo:"How to qualify:",
      regelSteps:[
      ...
      thresholdsTitle:"2026 Income Thresholds",
      harvesting: {
        label:"Loss Harvesting / ETF Swap",
        desc:"Reduces annual 'deemed distribution' taxable gains from ~20% to ~5% of growth",
      },
      regelbesteuerung: {
        label:"Regelbesteuerungsoption",
        desc:"0% KeSt if total income < €13,539/yr — the ultimate Austrian FIRE tax advantage",
      },
      taxStrategiesTitle:"📋 Austrian Tax Strategy Summary",
    },
    // ── Roadmap & Decision Lab ────────────────────────────────────────────────
    roadmap: {
      subTabs: { roadmap:"🗺️ Life Roadmap", lab:"🧪 Decision Lab" },
      lifeStory:"📖 Your Life Story",
      whatIf: {
        title:"🔀 What-If Scenarios",
        tip:"Toggle any scenario to instantly see how a major life decision changes your entire roadmap.",
        prefix:"🔀 What-If:",
        noHouseTitle:"Skip the House",
        earlyRetireTitle:"Retire 2 Years Earlier",
        nomadTitle:"Go Nomad FIRE",
        earlyRetireDescPrefix:"Accept 10% less",
        earlyRetireDescInstead:"instead of",
        nomadDescPrefix:"€700/mo in Asia/Balkans — FIRE target becomes",
        fireLabel:"FIRE:", ageLabel:"age",
        wifFireYear:"What-If FIRE Year", wifVsPlan:"vs Base Plan",
        wifTarget:"What-If Target",
        earlier:"earlier", later:"later",
      },
      timeline: {
        title:"🗓️ Your Life Timeline",
        today:"Today — Your Journey Starts",
        portfolioAt:"Portfolio at this point",
        pctOfTarget:"% of FIRE target",
        inYr:"in {n} yr", inYrs:"in {n} yrs",
      },
      nextActions: {
        title:"✅ Your Next 3 Actions",
        tip:"Highest-leverage moves based on your current numbers.",
        actionLabel:"Action",
      },
      lab: {
        infoBox:"🧪 Decision Lab: Save a snapshot of your current plan, then change any settings and save another. Compare them side-by-side to find your best life path. Snapshots survive page refreshes.",
        saveBtn:"📸 Save Current Plan as Snapshot",
        clearBtn:"🗑️ Clear All",
        snapshotsLabel:"{n}/4 snapshots",
        emptyMsg:"Save your current plan, change some settings, save another snapshot — then watch the comparison appear here.",
        comparing:"Comparing:",
        analysisTitle:"🤖 Analysis",
        analysisDefault:"Both plans are very similar — tweak spending mode, property, or tax strategy to see a meaningful difference.",
        verdictLabel:"Verdict:",
        sideBySideTitle:"Side-by-Side Comparison",
        netWorthTitle:"📊 Net Worth Comparison",
        tableMetric:"Metric",
        tableDelta:"Δ",
        rows: {
          spending:"Monthly Spending", fireYear:"FIRE Year", fireAge:"FIRE Age",
          fireTarget:"FIRE Target", wealthAt90:"Wealth at 90", totalTax:"Est. Total Tax",
          property:"Property", lifestyle:"Lifestyle Creep", partTime:"Part-Time", kv:"KV-Status",
        },
        snapRows: {
          spending:"Spending", portfolio:"Portfolio", fireYear:"FIRE Year", fireAge:"FIRE Age",
          mode:"Mode", property:"Property", bonuses:"Bonuses", lifestyle:"Lifestyle creep",
          tax:"Tax", partTime:"Part-time", renting:"Renting", inherited:"Inherited",
          none:"None", no:"No", standard:"Standard",
        },
        diff: {
          fireAgeDelta:"FIRE Age Δ", wealthDelta:"Wealth @ 90 Δ", taxDelta:"Est. Tax Δ",
          same:"Same", richer:"richer", savesMore:"saves more",
        },
      },
    },
  },
  ...
  de: {
    ...
    onboarding: {
      q1:"Wie alt bist du?", q2:"Wie viel hast du aktuell investiert? (€)", q3:"Wie viel sparst du pro Monat? (€)",
      q4:"Wie hoch ist dein monatliches Nettoeinkommen? (€)", q5:"In welchem Land lebst du?", q6:"Was ist dein FIRE-Ziel?",
      hints: { age:"Dein aktuelles Alter", portfolio:"Gesamt investiert in ETFs, Aktien usw. 0 wenn du gerade anfängst.", savings:"Wie viel du jeden Monat investierst", income:"Dein Nettogehalt nach Steuern" },
      countries: { austria:"🇦🇹 Österreich", germany:"🇩🇪 Deutschland", switzerland:"🇨🇭 Schweiz", other:"🌍 Sonstiges" },
    },
    share: "Plan teilen",
    copied: "Link kopiert!",
    langToggle: "EN",
    ui: {
      back:"← Zurück", continue:"Weiter →", skip:"Überspringen — Beispieldaten nutzen", close:"✕ schließen",
      remove:"Entfernen", add:"+ Hinzufügen", on:"AN", off:"AUS", portfolioOnly:"Nur Portfolio",
      now:"Jetzt!", done:"Erledigt", yearsAway:"J. entfernt", ageLabel:"Alter", priority:"PRIORITÄT",
      fireNow:"🎯 FIRE!", diminishing:"⚠️ Abnehmend", worthIt:"✅ Lohnt sich",
    },
    fireTypes: {
      ...
      fat:    { name:"Fat FIRE",     icon:"🥩", desc:"Luxuriöser Lebensstil, €3.000+/Monat. Hoher Komfort mit voller finanzieller Freiheit.",                              color:"#f472b6" },
      barista:{ name:"Barista FIRE", icon:"☕", desc:"Halb-Ruhestand. Teilzeitarbeit deckt Grundlagen, Portfolio deckt den Rest. Niedrigeres Ziel nötig.",                 color:"#16a34a" },
      ...
      nomad:  { name:"Nomad FIRE",   icon:"🌍", desc:"Geo-Arbitrage: In Niedrigkostenländern leben, damit dein Geld 3–5× länger reicht.",                                  color:"#0d9488" },
    },
    legacyMode: { zero:"Die with Zero 🎯", legacy:"Erbe hinterlassen 🏛️", grow:"Weiter wachsen 📈" },
    months: ["Jan","Feb","Mär","Apr","Mai","Jun","Jul","Aug","Sep","Okt","Nov","Dez"],
    exportModal: {
      title:"📤 Plan exportieren / importieren",
      howToShare:"💡 So teilst du deinen Plan:",
      howToShareDesc:"Kopiere den Text unten und schicke ihn per WhatsApp, E-Mail o.ä. Dein Freund fügt ihn in das Importfeld ein und lädt deinen genauen Plan.",
      planDataLabel:"Deine Plandaten (alles kopieren)",
      copyBtn:"📋 Plan in Zwischenablage kopieren",
      importLabel:"Plan importieren (hier einfügen)",
      importPlaceholder:"Plandaten deines Freundes hier einfügen...",
      loadBtn:"⬇️ Diesen Plan laden",
      invalidData:"Ungültige Plandaten. Bitte den vollständigen exportierten Text einfügen.",
      resetLabel:"Zurücksetzen",
    },
    learn: {
      title:"FIRE 101 — Alles, was du wissen musst",
      sub:"Kein Fachjargon. Einfache Erklärungen. Fang hier an.",
      typesTitle:"Die 8 FIRE-Typen — Wähle deinen Stil",
      yourMode:"◀ Dein aktueller Modus",
      readyMsg:"🚀 Du bist bereits auf dem Weg.",
      concepts: {
        fourPct: {
          title:"Die 4%-Regel",
          body:"Die Trinity-Studie zeigt: Wenn du 4% deines Portfolios pro Jahr entnimmst, hält es 30+ Jahre durch fast alle historischen Marktphasen. Deine FIRE-Zahl = Jahresausgaben × 25.\n\nBeispiel: €1.300/Monat = €15.600/Jahr → €15.600 × 25 = €390.000 benötigt.\n\nMit 'Die with Zero' nutzen wir ×20 (5% Entnahme). Mit 'Erbe hinterlassen' ×30 (3,3%).",
        },
        compound: {
          title:"Zinseszins — Das 8. Weltwunder",
          body:"Deine Renditen erzielen weitere Renditen. €10.000 bei 7%/Jahr werden in ~10 Jahren zu €20.000 — ohne einen Cent zusätzlich. Nach 20 Jahren sind es €40.000, nach 30 Jahren €76.000. Deshalb ist früh anfangen das Mächtigste, was du tun kannst.",
        },
        sorr: {
          title:"Renditereihenfolge-Risiko (SORR)",
          body:"Die Reihenfolge der Marktrenditen ist genauso wichtig wie der Durchschnitt. Ein Crash im ersten Jahr des Ruhestands ist viel schlimmer als einer im Jahr 20 — du verkaufst Anlagen zu Niedrigpreisen.\n\nGegenmittel: (1) 2 Jahre Cash halten, (2) Barista FIRE ermöglicht Verzicht auf Verkäufe in Crashs, (3) flexible Ausgaben.",
          highlight:"Gleiche Durchschnittsrendite, verschiedene Reihenfolge = völlig unterschiedliche Ergebnisse. Siehe Entnahme-Tab.",
        },
        coast: { title:"Coast FIRE — Der versteckte Meilenstein" },
      },
    },
    overview: {
      paramsTitle:"Deine Parameter",
      sliders: {
        savings:"Monatliche Sparrate", portfolio:"Aktuelles Portfolio", age:"Dein Alter",
        ret:"Erwartete Jahresrendite", sideIncome:"Jährliches Nebeneinkommen (Plasma, Bonus usw.)",
        creep:"Lifestyle-Inflation — jährlicher Ausgabenanstieg",
      },
      hints: {
        ret:"VWCE/MSCI World historisch ~7–9% nominal",
        creep:"Deine Ausgaben steigen jährlich um diesen % während der Ansparphase (Karriere, Familie usw.)",
        sideIncome:"€{v}/Jahr",
      },
      bonus: {
        title:"🎁 Österreichische Sonderzahlungen:",
        both:"Sowohl 13. (Weihnachtsgeld) als auch 14. Gehalt (Urlaubsgeld) eingerechnet.",
        thirteenth:"13. Gehalt (Weihnachtsgeld) eingerechnet.",
        fourteenth:"14. Gehalt (Urlaubsgeld) eingerechnet.",
        suffix:"Jedes addiert ~{amount} extra Ersparnisse/Jahr (bei 6% Sondersteuer auf die ersten €2.100). Bonus-Ersparnis gesamt:",
      },
      fiScore: {
        title:"FI-Score",
        tip:"Kombiniert Portfolio-Fortschritt (50 Pkt.), Sparrate (20 Pkt.) und Zeithorizont-Effizienz (20 Pkt.). 100 = du bist fertig!",
      },
    },
    projection: {
      chartTitle:"Portfolio-Wachstumsprognose",
      chartTip:"Dein prognostizierter Portfoliowert bei {ret}% Jahresrendite. Gestrichelte Linien = Meilensteine. Grün schattiert = Barista-Phase (Arbeit optional → volle Freiheit).",
      baristaPhaseLabel:"☕ Barista-Phase",
      baristaPhaseDesc:"Arbeit optional, Portfolio deckt {gap}+ /Monat Lücke",
      subTabs: { forecast:"📈 Prognose", crisis:"⚠️ Krisentest" },
      crisis: {
        selectLabel:"Krisenszenario auswählen:",
        triggerLabel:"Krisenauslöser-Jahr:",
        mitigationTitle:"🛡️ Wie man jede Krise überlebt — Maßnahmen-Checkliste",
        items: [
          { icon:"💵", title:"2-Jahres-Cash-Puffer",                impact:"★★★★★ Wichtigste Maßnahme" },
          { icon:"☕", title:"Barista FIRE als Sicherheitsnetz",    impact:"★★★★☆ Sehr effektiv" },
          { icon:"📉", title:"Dynamische Ausgaben (GK Guardrails)", impact:"★★★★☆ Bewährte Methode" },
          { icon:"🌍", title:"Geo-Arbitrage als Ausweichoption",    impact:"★★★☆☆ Flexible Option" },
          { icon:"🎯", title:"Größeres Portfolio (OMY)",            impact:"★★★☆☆ Abnehmender Nutzen" },
        ],
      },
    },
    fireCalc: {
      title:"FIRE-Zahlen-Rechner",
      tip:"Deine FIRE-Zahl hängt von Ausgaben UND Multiplikator ab. 'Die with Zero' = ×20 (5% Entnahme). 'Erbe hinterlassen' = ×30 (3,3%). Klassisch = ×25 (4%).",
      spendingLabel:"Monatliches Ausgabenziel",
      spendingHint:"Nutze den Budget-Tab um deine echte Zahl zu berechnen",
      modes: { zero:"Die with Zero", classic:"Klassische 4%", legacy:"Erbe hinterlassen" },
      boxes: {
        fireNumber:"FIRE-Zahl", monthlyPassive:"Monatlich passiv", atTarget:"bei Ziel",
        fireYear:"FIRE-Jahr", progress:"Fortschritt", ofTheWayThere:"des Ziels erreicht",
      },
      barista: {
        title:"☕ Barista FIRE",
        tip:"Teilzeiteinkommen + Portfolio-Entnahme = volle monatliche Deckung. Dynamisches Ziel: (Ausgaben − Barista-Einkommen) × 12 × (100/SWR).",
        incomeLabel:"Monatliches Teilzeiteinkommen",
        wageLabel:"Stundenlohn (für Arbeitsstunden-Berechnung)",
        wageHint:"Zur Berechnung der wöchentlichen Arbeitsstunden für Barista FIRE",
        gapLabel:"Portfolio-Lücke/Mo", gapSub:"muss Portfolio decken",
        targetLabel:"Barista-Ziel", yearLabel:"Barista-Jahr",
        vsFireLabel:"vs. volles FIRE", timeSaved:"Zeit gespart",
        workLifeTitle:"☕ Barista Work-Life-Rechner",
        hrsNeeded:"STD/WOCHE BENÖTIGT", vsFullTime:"vs. 40 Std. Vollzeit",
        freeTimeLabel:"FREIZEIT", hrsRecovered:"Std./Wo gewonnen", ofFullTime:"% der Vollzeit",
        monthlyIncomeLabel:"MONATLICHES EINKOMMEN", grossPerMonth:"/Monat brutto", targetApprox:"≈ Ziel",
        coverageTitle:"Monatliches Budget — Deckungsübersicht",
        workIncomeLabel:"🍵 Arbeitseinkommen:", portShareLabel:"💼 Portfolio:",
        workTag:"🍵 Arbeit", portTag:"💼 Portfolio", totalCovered:"Gesamtdeckung:",
        advantage:"☕ Der Barista-FIRE-Vorteil:",
        instead:"Statt", saving:"eine Ersparnis von",
        working:"Nur", hrsAt:"Std./Woche bei", gives:"gibt dir",
        freedomSuffix:"Stunden Freiheit pro Woche — bei voll nachhaltigen Finanzen.",
      },
      omy: {
        title:"⏰ One More Year (OMY) — Analyse",
        tip:"Solltest du noch ein Jahr länger arbeiten? Dieses Tool zeigt den genauen Sicherheitsgewinn — und wann der Grenznutzen zu gering wird um die Freiheit aufzuschieben.",
        syndrome:"💭 One-More-Year-Syndrom",
        syndromeDesc:"ist eine der größten FIRE-Fallen. Jedes Extra-Jahr fühlt sich 'sicherer' an — aber der Grenznutzen nimmt nach dem 1.–2. Jahr stark ab. Dieses Tool quantifiziert genau was jedes Extra-Jahr bringt.",
        headers: { extra:"Extra-Jahre", portfolio:"Portfolio bei FIRE", failRate:"40J-Ausfallrate", improvement:"Verbesserung", marginal:"Grenznutzen", verdict:"Urteil" },
        baseline:"Basis", lessRisk:"% weniger Risiko",
        insight:"📊 Wichtige Erkenntnis: Die größte Risikoreduktion kommt von Jahr 0→1",
        tradingLife:"Ab einem Punkt tauscht mehr Arbeit nur noch das Leben gegen marginale Statistiken.",
      },
    },
    compare: {
      title:"FIRE-Typ Timeline-Vergleich",
      tip:"Sieh genau, wann du jeden FIRE-Typ auf Basis deiner aktuellen Parameter erreichen würdest. Passe Ausgabenmodus und Sparrate an.",
      headers: { type:"FIRE-Typ", spend:"Monatsausgaben", target:"Ziel", year:"Jahr", age:"Alter", yearsAway:"Jahre entfernt", status:"Status" },
      doneNow:"✅ Jetzt!", done:"Fertig",
    },
    withdrawal: {
      failureRates: {
        title:"Portfolio-Ausfallwahrscheinlichkeiten",
        swrLabel:"SWR-Annahme",
        safe:"🟢 Sicher", ok:"🟡 OK", caution:"🟠 Achtung", risky:"🔴 Riskant",
        safetyValve: {
          title:"☕ Sicherheitsventil-Schalter",
          desc:"Zeigt den Effekt von +5 Std./Woche Arbeit in Crashs",
          suffix:"Das reduziert deine effektive Entnahme und senkt die Ausfallrate in allen Zeithorizonten oben.",
          baristaBeats:"Deshalb ist Barista FIRE sicherer als traditionelles FIRE.",
        },
      },
      sorr: {
        title:"Renditereihenfolge-Risiko",
        warning:"⚠️ Beide Szenarien unten haben die gleiche Durchschnittsrendite (~7%), aber völlig unterschiedliche Ergebnisse wegen der Renditereihenfolge.",
        lucky:"Glücklich (Guter Start)", unlucky:"Unglücklich (Schlechter Start)",
      },
      gk: {
        title:"🛡️ Guyton-Klinger Guardrails — Dynamische Entnahme",
        tip:"Statt starrer 4%-Entnahme erlauben Guyton-Klinger-Guardrails MEHR Ausgaben in guten Jahren und WENIGER in schlechten. Zwei Regeln: Capital-Preservation (SWR > 6% → Ausgaben −10%) und Prosperity (Portfolio +20% und SWR niedrig → Ausgaben +10%). Floor und Ceiling sichern ab.",
        infoBox:"💡 So funktioniert es: Deine Ausgaben sind lebendig. Märkte +20%? Gönne dir was — Ausgaben steigen 10%. Entnahmerate gefährlich hoch? Restaurantbesuche 10% kürzen. Das Ergebnis: ein viel resilienteres Ruhestandsportfolio.",
        floorLabel:"Ausgaben-Untergrenze (% des Ziels)", floorHint:"Das Minimum, mit dem du immer leben kannst",
        ceilLabel:"Ausgaben-Obergrenze (% des Ziels)", ceilHint:"Das Maximum, das du dir erlaubst — die Luxusgrenze",
        boxes: {
          floor:"Ausgaben-Untergrenze", floorSub:"/Monat Minimum",
          base:"Basis-Ausgaben", baseSub:"/Monat Ziel",
          ceil:"Ausgaben-Obergrenze", ceilSub:"/Monat Maximum",
          vs:"vs. fixer SWR", vsSub:"historisch bewiesen",
        },
        chartDesc:"Portfolio-Verlauf über 40 Jahre — GK vs. fixer 4% (mit realistischer historischer Renditesequenz)",
        legends: { gk:"GK Portfolio", fixed:"Fixes 4% Portfolio (gestrichelt)", spend:"GK Monatsausgaben (rechte Achse)" },
        why:"🛡️ Warum Guardrails besser sind als fixer 4%:",
        whyDesc:"Historische Forschung (Guyton & Klinger, 2006) zeigt: Diese zwei Regeln erhöhen nachhaltige Entnahmeraten auf 5–6% bei gleichzeitig gesenkten Ausfallraten. Die Erkenntnis: Eine kleine Ausgabenanpassung von 10% in schlechten Jahren verhindert Portfolio-Zusammenbruch.",
      },
    },
    budget: {
      title:"Monatlicher Ausgaben-Rechner",
      tip:"Gib deine tatsächlichen Monatsausgaben ein um deine echte Ausgabenzahl zu berechnen. Diese fließt direkt in deine FIRE-Berechnung ein.",
      categoryPlaceholder:"Kategoriename", amountPlaceholder:"€/Mo",
      totalLabel:"Monatliche Gesamtausgaben", annual:"Jährlich", fireTarget:"FIRE-Ziel (×{mult})", fireYearLabel:"FIRE-Jahr",
      useBudgetLabel:"Dieses Budget als FIRE-Ausgaben nutzen",
      useBudgetActive:"✅ Budget steuert alle FIRE-Berechnungen",
      overrideInfo:"💡 Budget-Override aktiv: €{amount}/Mo überschreibt den \"{mode}\"-Preset. Dein neues FIRE-Ziel ist {target}. Alle Tabs, Projektionen und Entnahmeberechnungen nutzen nun diese Zahl.",
    },
    travel: {
      title:"Reise-Rechner",
      budgetLabel:"Monatliches Reisebudget",
      styleLabel:"Reisestil",
      styles: { budget:"Budget", standard:"Standard", comfort:"Komfort" },
      tooLow:"⚠️ Budget zu niedrig für eine sinnvolle Reise auf {style}-Niveau",
      fullMonth:"🎉 Voller Monat+ Trip möglich!",
      baseSelf:"🌟 Du könntest dich hier zeitweise niederlassen!",
      nomadTitle:"🌍 Nomad FIRE Deep Dive",
      comfortableLifestyle:"komfortabler Lebensstil",
      daysLabel:"Tage",
      weeksLabel:"Wochen/Jahr",
    },
    life: {
      eventTitle:"Lebens-Ereignis-Planer",
      noEvents:"Noch keine Lebensereignisse hinzugefügt. Unten ergänzen.",
      evtPlaceholder:"🏠 Ereignisname",
      yearPlaceholder:"Jahr",
      costPlaceholder:"Kosten €",
      coupleTitle:"👫 Paar-Modus",
      enableCouple:"Paar-Modus aktivieren",
      partnerSavings:"Monatliche Sparrate des Partners",
      partnerPortfolio:"Aktuelles Portfolio des Partners",
      combinedPortfolio:"Gemeinsames Portfolio",
      combinedSavings:"Gemeinsame Sparrate/Mo",
      combinedFireYear:"Gemeinsames FIRE-Jahr",
      coupleInfo:"💡 Mit zwei Einkommen erreichst du FIRE viel schneller. Ein Partner kann zuerst in Rente gehen, während der andere weiterarbeitet — und die Krankenversicherung für beide aktiv hält.",
      ptTitle:"Teilzeit-Übergangs-Fahrplan",
      ptFull:"Vollzeit-Arbeit",
      pt4d:"4 Tage/Woche", pt3d:"3 Tage/Woche",
      ptBarista:"Barista (2 Tage)",
      ptFire:"🎯 Volles FIRE",
      portfolioLabel:"Portfolio:",
      portfolioOnly:"Nur Portfolio",
      freeLabel:"🎉 Frei!",
      daysWk:"Tage/Wo",
    },
    austria: {
      overviewBox:"🇦🇹 Österreichische FIRE-Vorteile — Österreich bietet überraschend starke FIRE-Vorteile: Regelbesteuerungsoption (0% KeSt bei niedrigem Einkommen), SV-Rückerstattung, Wohnbauförderung und eine solide Staatspension.",
      gering: {
        title:"Geringfügigkeitsgrenze — Die magische SV-Schwelle",
        tip:"Unter €551,10/Monat = keine Sozialversicherungsbeiträge. Ideal für Barista FIRE.",
        incomeLabel:"Geplantes Monatseinkommen",
        statusUnder:"✅ Unter der Grenze", statusOver:"⚠️ Über der Grenze",
        svNotRequired:"Keine SV erforderlich!", svApplies:"SV-Beiträge werden fällig",
        svSavingLabel:"SV-Ersparnis", vsFullEmp:"vs. Vollbeschäftigung",
        annualSavingLabel:"Jahresersparnis", perYear:"pro Jahr",
      },
      baristaCard: {
        title:"☕ Geringfügige Beschäftigung — Die Geheimwaffe für Barista FIRE",
        tip:"Unter €518,44/Mo zu verdienen gibt dir Kranken- und Sozialversicherung zu fast keinen Kosten. Das effizienteste legale Arbeitsverhältnis für Barista FIRE in Österreich.",
        baristaTargetLabel:"BARISTA-ZIEL",
        idealWageLabel:"IDEALER BARISTA-LOHN", stayUnder:"Unter der Grenze bleiben",
        kvCostLabel:"KV-KOSTEN (§19a)", kvPerMonth:"/Monat Opt-in",
        savingsVsLabel:"ERSPARNIS VS. PRIVATIER", perYearSaved:"/Jahr gespart",
        regelTitle:"🎯 Regelbesteuerungsoption für Barista-FIRE-Einsteiger",
      },
    },
    re: {
      title:"Immobilien-Simulator",
      modeOwn:"🏠 Eigenheim", modeInvest:"💼 Anlageimmobilie",
      ...
      netWorthProp:"Vermögen (Mit Immobilie)", netWorthEtf:"Vermögen (Nur ETF)",
      equity:"Eigenkapital", etfPortfolio:"ETF-Portfolio",
      ...
      modes: {
        none:   { label:"🚫 Keine Immobilie",     desc:"Aktuell mietend. Alle Ersparnisse gehen in ETFs." },
        own:    { label:"🏠 Kaufen — Eigenheim",   desc:"Primärwohnsitz kaufen. Niedrigeres FIRE-Ziel nach Abbezahlung." },
        invest: { label:"💼 Kaufen — Anlage/Miete",desc:"Anlageimmobilie. Mieteinnahmen decken Kredit und generieren Cashflow." },
        inherit:{ label:"🎁 Erben",               desc:"Immobilie ohne Kaufkosten erhalten. Sofortiger Eigenkapitalschub." },
        build:  { label:"🏗️ Selbst bauen",         desc:"Eigenes Haus bauen. Mehr Aufwand, potentiell günstiger pro m²." },
      },
      inheritTitle:"🎁 Erbschafts-Immobilien-Simulator",
      inheritValueLabel:"Wert der geerbten Immobilie",
      inheritValueSub:"aktueller Marktwert",
      inheritValue20ySub:"bei {pct}%/Jahr",
      housingBenefitSub:"vs. weiterhin mieten",
      targetReducLabel:"FIRE-Ziel-Reduktion", targetReducSub:"niedrigeres FIRE-Ziel",
      adjFireYearLabel:"Angepasstes FIRE-Jahr", adjFireYearSub:"mit Erbschaft",
      vsStandardLabel:"vs. Standard-FIRE", vsStandardSub:"Jahre früher",
      inheritTip:"Sobald die Hypothek abbezahlt ist, reduzieren sich deine Wohnkosten auf nur Instandhaltung — und dein FIRE-Ziel sinkt automatisch.",
      investTip:"Mieteinnahmen minus Kredit und Kosten = dein monatlicher Cashflow. Kann reinvestiert oder für frühere FIRE-Erreichung genutzt werden.",
      buildTitle:"🏗️ Selbstbau-Simulator",
      buildLandLabel:"Grundstückskaufpreis", buildLandHint:"Grundstück — jetzt kaufen, später bauen",
      buildCostLabel:"Baukosten", buildCostHint:"Österreich: ~€1.500–2.500/m² je nach Standard",
      buildYearLabel:"Fertigstellungsjahr",
      totalCostLabel:"Gesamtprojektkosten", totalCostSub:"Grundstück + Bau",
      benchmarkLabel:"vs. Kauf Äquivalent", benchmarkSub:"Marktpreis-Benchmark",
      potSavingLabel:"Potentielle Ersparnis", potSavingSub:"vs. Marktkauf",
      monthlyMortgLabel:"Monatliche Kreditrate", monthlyMortgSub:"/Monat nach Fertigstellung",
      completionYearLabel:"Fertigstellungsjahr", mortgageFreeLabel:"Kreditfrei",
      mortgageTitle:"📊 Kredit-Zusammenfassung",
      fireImpactStandard:"Standard-FIRE-Ziel",
      fireImpactBenefit:"Wohnkostenvorteil nach Abbezahlung", fireImpactBenefitSub:"gespart vs. mieten",
      fireImpactAdj:"Angepasstes FIRE-Ziel",
      fireImpactStdYear:"FIRE-Jahr (Standard)", fireImpactWithProp:"FIRE-Jahr (mit Immobilie)",
      fireImpactDiff:"Unterschied",
      btlTitle:"🎯 Anlageimmobilien-FIRE-Beschleunigung",
      btlCashflowMo:"Monatlicher Netto-Cashflow", btlCashflowYr:"Jährlicher Netto-Cashflow",
      btlFireStd:"FIRE-Jahr (Standard)", btlFireWith:"FIRE-Jahr (mit Cashflow)",
      btlGross:"Bruttorendite", btlNet:"Nettorendite",
      rentHintChange:"Zur Berechnung deiner realen monatlichen Kostenveränderung",
      rentHintInherit:"Aktuelle Miete (endet mit Erbschaft)",
      buyVsRentTitle:"Kaufen vs. Mieten — 35-Jahre Vermögensentwicklung",
      loanTermYrsLabel:"Jahre",
    },
    taxoptimizer: {
      boxes: {
        gross30:"Brutto-Portfolio (Jahr 30)", gross30Sub:"ohne Steuerbetrachtung",
        afterDrag:"Nach jährl. Steuer-Drag", afterDragSub:"thesaurierender ETF, jährl. KESt",
        spendable:"Real verfügbar", spendableSub:"nach Exit-Steuer auf unrealisierte Gewinne",
        totalTax:"Gesamte Steuerkosten", totalTaxSub:"über 30 Jahre",
        taxPct:"Steuer als % des Bruttos", taxPctSub:"deines Vermögens",
        strategy:"Strategie", strategySub:"aktueller Modus",
      },
      strategies: { zero:"0% KESt 🎉", harvesting:"Harvesting ♻️", standard:"Standard" },
      dragTitle:"📉 Steuer-Drag — 30 Jahre Vermögensverlust visualisiert",
      dragLegend: { gross:"Brutto (ohne Steuer)", afterDrag:"Nach jährl. Steuer-Drag", spendable:"Real verfügbar (nach Exit-KESt)" },
      regelTitle:"🎯 Regelbesteuerungsoption — Die österreichische 0%-Steuerstrategie",
      regelHowTo:"So qualifizierst du dich:",
      regelSteps:[
        "Dein gesamtes Jahreseinkommen (Gehalt + Kapitalgewinne + Dividenden) muss unter €13.539/Jahr bleiben",
        "Das ist das Einkommensniveau von Barista FIRE oder Frühpension mit moderaten Entnahmen",
        "Einkommensteuererklärung einreichen und 'Regelbesteuerungsoption' ankreuzen",
        "FinanzOnline wendet automatisch die Günstigerprüfung an — nutzt deinen persönlichen Steuersatz wenn niedriger als 27,5%",
        "Unter dem Steuerfreigrenze beträgt dein persönlicher Steuersatz effektiv 0%",
      ],
      thresholdsTitle:"Einkommensgrenzen 2026",
      harvesting: {
        label:"Verlustverrechnung / ETF-Tausch",
        desc:"Reduziert jährliche 'ausschüttungsgleiche Erträge' von ~20% auf ~5% des Wachstums",
      },
      regelbesteuerung: {
        label:"Regelbesteuerungsoption",
        desc:"0% KESt bei Gesamteinkommen < €13.539/Jahr — der ultimative österreichische FIRE-Steuerbonus",
      },
      taxStrategiesTitle:"📋 Österreichische Steuerstrategie-Übersicht",
    },
    roadmap: {
      subTabs: { roadmap:"🗺️ Lebens-Fahrplan", lab:"🧪 Entscheidungslabor" },
      lifeStory:"📖 Deine Lebensgeschichte",
      whatIf: {
        title:"🔀 Was-wäre-wenn Szenarien",
        tip:"Schalte ein Szenario ein und sieh sofort wie eine große Lebensentscheidung deinen gesamten Fahrplan verändert.",
        prefix:"🔀 Was wäre wenn:",
        noHouseTitle:"Haus überspringen",
        earlyRetireTitle:"2 Jahre früher in Rente",
        nomadTitle:"Nomad FIRE",
        earlyRetireDescPrefix:"10% weniger akzeptieren",
        earlyRetireDescInstead:"statt",
        nomadDescPrefix:"€700/Mo in Asien/Balkan — FIRE-Ziel wird",
        fireLabel:"FIRE:", ageLabel:"Alter",
        wifFireYear:"Was-wäre-wenn FIRE-Jahr", wifVsPlan:"vs. Basisplan",
        wifTarget:"Was-wäre-wenn Ziel",
        earlier:"früher", later:"später",
      },
      timeline: {
        title:"🗓️ Deine Lebens-Timeline",
        today:"Heute — Deine Reise beginnt",
        portfolioAt:"Portfolio zu diesem Zeitpunkt",
        pctOfTarget:"% des FIRE-Ziels",
        inYr:"in {n} J.", inYrs:"in {n} J.",
      },
      nextActions: {
        title:"✅ Deine nächsten 3 Maßnahmen",
        tip:"Maßnahmen mit dem größten Hebel basierend auf deinen aktuellen Zahlen.",
        actionLabel:"Maßnahme",
      },
      lab: {
        infoBox:"🧪 Entscheidungslabor: Speichere deinen aktuellen Plan als Snapshot, ändere Einstellungen und speichere einen weiteren. Vergleiche sie nebeneinander um deinen besten Lebensweg zu finden. Snapshots überleben Seitenaktualisierungen.",
        saveBtn:"📸 Aktuellen Plan als Snapshot speichern",
        clearBtn:"🗑️ Alle löschen",
        snapshotsLabel:"{n}/4 Snapshots",
        emptyMsg:"Speichere deinen aktuellen Plan, ändere Einstellungen, speichere einen weiteren Snapshot — dann erscheint hier der Vergleich.",
        comparing:"Vergleich:",
        analysisTitle:"🤖 Analyse",
        analysisDefault:"Beide Pläne sind sehr ähnlich — ändere Ausgabenmodus, Immobilien- oder Steuerstrategie für einen bedeutenden Unterschied.",
        verdictLabel:"Urteil:",
        sideBySideTitle:"Nebeneinander-Vergleich",
        netWorthTitle:"📊 Vermögensvergleich",
        tableMetric:"Kennzahl",
        tableDelta:"Δ",
        rows: {
          spending:"Monatsausgaben", fireYear:"FIRE-Jahr", fireAge:"FIRE-Alter",
          fireTarget:"FIRE-Ziel", wealthAt90:"Vermögen mit 90", totalTax:"Geschätzte Gesamtsteuer",
          property:"Immobilie", lifestyle:"Lifestyle-Inflation", partTime:"Teilzeit", kv:"KV-Status",
        },
        snapRows: {
          spending:"Ausgaben", portfolio:"Portfolio", fireYear:"FIRE-Jahr", fireAge:"FIRE-Alter",
          mode:"Modus", property:"Immobilie", bonuses:"Boni", lifestyle:"Lifestyle-Inflation",
          tax:"Steuer", partTime:"Teilzeit", renting:"Mietend", inherited:"Geerbt",
          none:"Keine", no:"Nein", standard:"Standard",
        },
        diff: {
          fireAgeDelta:"FIRE-Alter Δ", wealthDelta:"Vermögen mit 90 Δ", taxDelta:"Geschätzte Steuer Δ",
          same:"Gleich", richer:"reicher", savesMore:"spart mehr",
        },
      },
    },
  }
...
function Onboarding({ onComplete, lang }) {
  ...
  const steps = [
    { key:"age",           label:t.onboarding.q1, type:"number",   min:18,  max:70,      step:1,    icon:"🎂", hint:t.onboarding.hints.age },
    { key:"portfolio",     label:t.onboarding.q2, type:"number",   min:0,   max:2000000, step:1000, icon:"💼", hint:t.onboarding.hints.portfolio },
    { key:"monthlySavings",label:t.onboarding.q3, type:"number",   min:0,   max:5000,    step:50,   icon:"💰", hint:t.onboarding.hints.savings },
    { key:"monthlyIncome", label:t.onboarding.q4, type:"number",   min:0,   max:15000,   step:100,  icon:"💳", hint:t.onboarding.hints.income },
    { key:"country",       label:t.onboarding.q5, type:"select",   icon:"🌍",
      options:[
        {v:"austria",    l:t.onboarding.countries.austria},
        {v:"germany",    l:t.onboarding.countries.germany},
        {v:"switzerland",l:t.onboarding.countries.switzerland},
        {v:"other",      l:t.onboarding.countries.other},
      ]},
      ...
      <div style={{ maxWidth:480, width:"100%" }}>
        ...
        <div style={{ display:"flex", gap:12, marginTop:20 }}>
          ...
          <button onClick={() => isLast ? onComplete(data) : setStep(step+1)}
            ...
            {isLast ? t.startBtn : t.ui.continue}
          </button>
        </div>
...
export default function FIREApp() {
  ...
  const handleImport = () => {
    ...
    } catch(e) { setImportError(T[lang].exportModal.invalidData); }
  };
    ...
    <div style={{ background:C.bg, minHeight:"100vh", color:C.text, fontFamily:C.font }}>
        ...
        <div style={{ position:"fixed", inset:0, background:"#000a", zIndex:1000, display:"flex", alignItems:"center", justifyContent:"center", padding:16 }}
          ...
          <div style={{ background:C.card, border:`1px solid ${C.gold}44`, borderRadius:18, padding:24, maxWidth:500, width:"100%", boxShadow:"0 20px 80px #000" }}>
            <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:16 }}>
              <div style={{ fontSize:14, fontWeight:700, color:C.gold }}>{t.exportModal.title}</div>
            ...
            <InfoBox color={C.blue}>
              💡 <strong>{t.exportModal.howToShare}</strong> {t.exportModal.howToShareDesc}
            </InfoBox>
            <div style={{ marginTop:14 }}>
              <div style={{ fontSize:11, color:C.textMuted, marginBottom:6, textTransform:"uppercase", letterSpacing:1 }}>{t.exportModal.planDataLabel}</div>
              ...
              <button onClick={handleExportCopy}
                ...
                {shareMsg || t.exportModal.copyBtn}
              </button>
            </div>
            <div style={{ margin:"18px 0", borderTop:`1px solid ${C.border}` }} />
            <div>
              <div style={{ fontSize:11, color:C.textMuted, marginBottom:6, textTransform:"uppercase", letterSpacing:1 }}>{t.exportModal.importLabel}</div>
              <textarea value={importText} onChange={e => { setImportText(e.target.value); setImportError(""); }}
                placeholder={t.exportModal.importPlaceholder}
      ...
      <div style={{ maxWidth:940, margin:"0 auto", padding:"20px 14px 60px" }}>
        ...
        {tab === "learn" && (
          <div>
            <div style={{ textAlign:"center", marginBottom:24 }}>
              ...
              <h2 style={{ margin:0, fontSize:20, fontWeight:400, color:C.text }}>{t.learn.title}</h2>
              <p style={{ color:C.textSec, fontSize:13, margin:"8px 0 0" }}>{t.learn.sub}</p>
            </div>

            {/* FIRE types grid */}
            <Card title={t.learn.typesTitle} accent={C.gold}>
              <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(200px,1fr))", gap:10 }}>
                {Object.entries(t.fireTypes).map(([k,v]) => (
                  <div key={k} onClick={() => { setSpendMode(k in spendMap?k:"regular"); setTab("projection"); }}
                    ...
                    {k === spendMode && <div style={{ fontSize:11, color:v.color, marginTop:6, fontWeight:700 }}>{t.learn.yourMode}</div>}
                  </div>
                ))}
              </div>
            </Card>
            ...
            {/* Core concepts */}
            {[
              { emoji:"📐", title:t.learn.concepts.fourPct.title, accent:C.blue,
                body:t.learn.concepts.fourPct.body,
                highlight:`${lang==="de"?"Aktuelle FIRE-Zahl":"Current FIRE Number"} (${legacyMult}× ${lang==="de"?"Multiplikator":"multiplier"}): ${euro(fireNum)}` },
              { emoji:"📈", title:t.learn.concepts.compound.title, accent:C.green,
                body:t.learn.concepts.compound.body,
                highlight:`${lang==="de"?"Bei":"At"} ${(annualReturn*100).toFixed(1)}% ${lang==="de"?"Rendite, deine":"return, your"} €${(portfolio/1000).toFixed(0)}k ${lang==="de"?"verdient":"earns"} €${dailyPassive}/${lang==="de"?"Tag":"day"} ${lang==="de"?"automatisch":"automatically"}` },
              { emoji:"⚡", title:t.learn.concepts.sorr.title, accent:C.red,
                body:lang==="de"?t.learn.concepts.sorr.body:(
                  "The order of market returns matters as much as the average. A crash in your first year of retirement is much worse than a crash in year 20. Why? Because you're selling investments at low prices to cover living costs.\n\nAntidote: (1) Keep 2 years of cash, (2) Barista FIRE lets you avoid selling in crashes, (3) flexible spending."
                ),
                highlight:t.learn.concepts.sorr.highlight },
              { emoji:"🏖️", title:t.learn.concepts.coast.title, accent:C.cyan,
                body:lang==="de"
                  ? `Coast FIRE bedeutet: Du hast bereits genug investiert, sodass Zinseszins allein deine FIRE-Zahl bis zum Rentenalter erreicht — auch wenn du nie wieder einen Cent sparst.\n\nDein Coast-FIRE-Ziel mit ${age}: ${euro(coastTarget)} (wächst bis ${age+65-age} auf ${euro(fireNum)}).\n\n${portfolio >= coastTarget ? "🎉 Du hast Coast FIRE bereits erreicht! Du könntest aufhören zu sparen und trotzdem sicher in Rente gehen." : `Dir fehlen noch ${euro(coastTarget - portfolio)} für Coast FIRE.`}`
                  : `Coast FIRE means you've invested enough that compound growth alone will reach your FIRE number by retirement age — even if you never invest another cent.\n\nYour Coast FIRE target at age ${age}: ${euro(coastTarget)} (so it grows to ${euro(fireNum)} by age 65).\n\n${portfolio >= coastTarget ? "🎉 You've already hit Coast FIRE! You could stop saving entirely and still reach retirement security." : `You're ${euro(coastTarget - portfolio)} away from Coast FIRE.`}`,
                highlight:coastDone
                  ? (lang==="de"?"✅ Coast FIRE erreicht! Du kannst aufhören zu investieren und trotzdem mit 65 in Rente gehen.":"✅ Coast FIRE achieved! You can stop investing and still retire at 65.")
                  : `${lang==="de"?"Coast-FIRE-Ziel:":"Coast FIRE target:"} ${euro(coastTarget)}` },
            ].map((item, i) => (
            ...
            <InfoBox color={C.green}>
              {t.learn.readyMsg} {lang==="de"?"Dein FI-Score ist":"Your FI Score is"} {fiScore}/100. {portfolio >= coastTarget ? (lang==="de"?"Coast FIRE wurde bereits erreicht!":"Coast FIRE is already achieved!") : `${lang==="de"?"Du hast":"You're"} ${pct(portfolio,coastTarget).toFixed(0)}% ${lang==="de"?"des Coast-FIRE-Ziels erreicht.":"of the way to Coast FIRE."}`} {lang==="de"?"Öffne Überblick für dein vollständiges Bild.":"Head to the Overview tab to see your full picture."}
            </InfoBox>
          </div>
        )}
        ...
        {tab === "overview" && (
          <div>
            {/* Controls */}
            <Card title={t.overview.paramsTitle} accent={C.textSec}>
              <G2>
                <div>
                  <Slider label={t.overview.sliders.savings}  value={monthlySavings} min={0} max={5000} step={50} onChange={setMonthlySavings} format={v=>`€${v}/mo`} />
                  <Slider label={t.overview.sliders.portfolio} value={portfolio} min={0} max={2000000} step={1000} onChange={setPortfolio} format={v=>kilo(v)} />
                  <Slider label={t.overview.sliders.age}      value={age} min={18} max={65} step={1} onChange={setAge} format={v=>`${v} ${lang==="de"?"Jahre alt":"years old"}`} color={C.purple} />
                </div>
                <div>
                  <Slider label={t.overview.sliders.ret} value={annualReturn} min={0.03} max={0.12} step={0.005} onChange={setAnnualReturn} format={v=>`${(v*100).toFixed(1)}%`} hint={t.overview.hints.ret} />
                  <Slider label={t.overview.sliders.sideIncome} value={sideIncome} min={0} max={10000} step={100} onChange={setSideIncome} format={v=>`€${v}/${lang==="de"?"Jahr":"yr"}`} color={C.red} />
                  {lifestyleCreep > 0 && (
                    <Slider label={t.overview.sliders.creep} value={lifestyleCreep} min={0.5} max={5} step={0.5} onChange={setLifestyleCreep} format={v=>`+${v}%/yr`} color={C.pink} hint={t.overview.hints.creep} />
                  )}
                  {(bonus13 || bonus14) && (
                    <div style={{ background:C.orange+"10", border:`1px solid ${C.orange}33`, borderRadius:10, padding:"10px 14px", fontSize:11, color:"#fb923c", lineHeight:1.7 }}>
                      {t.overview.bonus.title}{" "}
                      {bonus13 && bonus14 ? t.overview.bonus.both : bonus13 ? t.overview.bonus.thirteenth : t.overview.bonus.fourteenth}{" "}
                      {t.overview.bonus.suffix.replace("{amount}", euro(Math.round(monthlySavings * 0.92)))} <strong>{euro(bonusAnnual)}/{lang==="de"?"Jahr":"yr"}</strong>.
                    </div>
                  )}
                </div>
              </G2>
            ...
            <Card title={t.overview.fiScore.title} accent={C.gold} titleRight={<Tip>{t.overview.fiScore.tip}</Tip>}>
        ...
        {tab === "projection" && (
          <div>
            ...
            <div style={{ display:"flex", gap:4, marginBottom:18, background:C.surface, borderRadius:12, padding:4 }}>
              {[["forecast",t.projection.subTabs.forecast],["crisis",t.projection.subTabs.crisis]].map(([id,lbl]) => (
            ...
            <Card title={t.projection.chartTitle} accent={C.gold} titleRight={<Tip>{t.projection.chartTip.replace("{ret}",(annualReturn*100).toFixed(1))}</Tip>}>
              <ResponsiveContainer width="100%" height={250}>
              ...
              {baristaYear && fireYear && baristaYear < fireYear && (
                <div style={{ display:"flex", alignItems:"center", gap:8, marginTop:10, background:C.coffeeGreen+"15", border:`1px solid ${C.coffeeGreen}33`, borderRadius:8, padding:"8px 14px" }}>
                  ...
                  <span style={{ fontSize:11, color:C.coffeeLight }}>
                    <strong>{t.projection.baristaPhaseLabel}</strong> · {baristaYear}–{fireYear} ({fireYear-baristaYear} {lang==="de"?"J.":"yrs"}) · {t.projection.baristaPhaseDesc.replace("{gap}", euro(Math.round(baristaGap)))}
                  </span>
                </div>
              )}
            </Card>
            ...
            {projSubTab === "crisis" && (<div>
              ...
              <Card title={t.projection.crisis.mitigationTitle} accent={C.gold}>
                <div style={{ display:"flex", flexDirection:"column", gap:8 }}>
                  {[
                    { ...t.projection.crisis.items[0], desc:`${lang==="de"?`Halte ${euro(spending*24)} (2 Jahresausgaben) in Cash/Geldmarkt. Niemals ETFs im Crash verkaufen.`:`Keep ${euro(spending*24)} (2 years of expenses) in cash/money market. Never sell ETFs during a crash — let the cash carry you.`}` },
                    { ...t.projection.crisis.items[1], desc:lang==="de"?`Wenn Portfolio −20%+, €${Math.round(spending*0.5)}/Mo Teilzeit verdienen. Das halbiert allein die Entnahmerate.`:`If portfolio drops 20%+, earn €${Math.round(spending*0.5)}/mo part-time. This alone halves your withdrawal rate.` },
                    { ...t.projection.crisis.items[2], desc:lang==="de"?"Diskretionäre Ausgaben 10% kürzen wenn Entnahmerate 6% überschreitet. Erhöhen wenn Märkte erholen.":"Cut discretionary spending 10% when your withdrawal rate breaches 6%. Ratchet back up when markets recover." },
                    { ...t.projection.crisis.items[3], desc:lang==="de"?`Vorübergehend in ein günstigeres Land ziehen. €${spending}/Mo in Wien → gleicher Lifestyle für €${Math.round(spending*0.55)}/Mo in Südostasien.`:`Temporarily relocate to a lower-cost country. €${spending}/mo in Vienna → the same lifestyle for €${Math.round(spending*0.55)}/mo in South East Asia.` },
                    { ...t.projection.crisis.items[4], desc:lang==="de"?`${fireYear && currentYear < fireYear ? "1–2 weitere Jahre" : "Etwas länger"} arbeiten baut ein größeres Polster auf. Siehe FIRE Rechner → OMY Tool.`:`Working just ${fireYear && currentYear < fireYear ? "1–2 more years" : "a bit longer"} builds a larger cushion. See FIRE Calc → OMY Tool.` },
                  ].map(m => (
        ...
        {tab === "fireCalc" && (
          <div>
            <Card title={t.fireCalc.title} accent={C.gold} titleRight={<Tip>{t.fireCalc.tip}</Tip>}>
              <G2>
                <div>
                  <Slider label={t.fireCalc.spendingLabel} value={spending} min={500} max={8000} step={100} onChange={() => {}} format={v=>`€${v}/mo`} hint={t.fireCalc.spendingHint} />
                  <div style={{ display:"flex", gap:8, flexWrap:"wrap", marginBottom:12 }}>
                    {[["zero",t.fireCalc.modes.zero,"×20",5,C.cyan],["grow",t.fireCalc.modes.classic,"×25",4,C.gold],["legacy",t.fireCalc.modes.legacy,"×30",3.3,C.purple]].map(([m,l,x,swrVal,c]) => (
                ...
                <div>
                  <G3>
                    <Box small label={t.fireCalc.boxes.fireNumber} value={kilo(fireNum)} sub={`×${legacyMult.toFixed(1)} (${swr}% SWR)`} color={C.gold} />
                    <Box small label={t.fireCalc.boxes.monthlyPassive} value={euro(Math.round(fireNum*annualReturn/12))} sub={t.fireCalc.boxes.atTarget} color={C.green} />
                    <Box small label={t.fireCalc.boxes.fireYear} value={fireYear||"2040+"} sub={fireYear?`${lang==="de"?"Alter":"age"} ${fireYear-currentYear+age}`:""} color={C.gold} />
                    <Box small label={t.fireCalc.boxes.progress} value={`${pct(portfolio,fireNum).toFixed(1)}%`} sub={t.fireCalc.boxes.ofTheWayThere} color={C.purple} />
                  </G3>
                </div>
              </G2>
            </Card>

            <Card title={t.fireCalc.barista.title} accent={C.coffeeGreen} titleRight={<Tip>{t.fireCalc.barista.tip}</Tip>}>
              {/* Controls */}
              <G2>
                <div>
                  <Slider label={t.fireCalc.barista.incomeLabel} value={baristaIncome} min={0} max={2000} step={50} onChange={setBaristaIncome} format={v=>`€${v}/mo`} color={C.coffeeGreen} />
                  <Slider label={t.fireCalc.barista.wageLabel} value={baristaHourlyWage} min={5} max={50} step={1} onChange={setBaristaHourlyWage} format={v=>`€${v}/hr`} color={C.coffeeLight} hint={t.fireCalc.barista.wageHint} />
                </div>
                <G3>
                  <Box small label={t.fireCalc.barista.gapLabel} value={baristaGap<=0?"€0 🎉":euro(baristaGap)} sub={t.fireCalc.barista.gapSub} color={baristaGap<=0?C.coffeeGreen:C.gold} />
                  <Box small label={t.fireCalc.barista.targetLabel} value={baristaTarget<=0?(lang==="de"?"Fertig!":"Done!"):kilo(baristaTarget)} sub={`×${legacyMult.toFixed(1)} (${swr}% SWR)`} color={C.coffeeGreen} />
                  <Box small label={t.fireCalc.barista.yearLabel} value={baristaTarget<=0?(lang==="de"?"Jetzt 🎉":"Now 🎉"):baristaYear?`${baristaYear}`:"2040+"} color={C.cyanLight} />
                  <Box small label={t.fireCalc.barista.vsFireLabel} value={baristaTarget>0&&fireYear&&baristaYear?`${fireYear-baristaYear} ${lang==="de"?"J. früher":"yrs earlier"}`:"—"} sub={t.fireCalc.barista.timeSaved} color={C.coffeeGreen} />
                </G3>
              </G2>
              ...
              <div style={{ background:`linear-gradient(135deg,${C.coffeeGreen}18,${C.coffeeDark}10)`, border:`1px solid ${C.coffeeGreen}44`, borderRadius:14, padding:"16px 18px", marginTop:14 }}>
                <div style={{ fontSize:11, fontWeight:700, letterSpacing:2, color:C.coffeeLight, textTransform:"uppercase", marginBottom:12 }}>{t.fireCalc.barista.workLifeTitle}</div>
                <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(130px,1fr))", gap:10, marginBottom:14 }}>
                  <div style={{ background:C.surface, borderRadius:10, padding:"12px 14px", textAlign:"center" }}>
                    <div style={{ fontSize:10, color:C.textMuted, letterSpacing:1, marginBottom:4 }}>{t.fireCalc.barista.hrsNeeded}</div>
                    ...
                    <div style={{ fontSize:10, color:C.coffeeLight, marginTop:3 }}>{t.fireCalc.barista.vsFullTime}</div>
                  </div>
                  <div style={{ background:C.surface, borderRadius:10, padding:"12px 14px", textAlign:"center" }}>
                    <div style={{ fontSize:10, color:C.textMuted, letterSpacing:1, marginBottom:4 }}>{t.fireCalc.barista.freeTimeLabel}</div>
                    ...
                    <div style={{ fontSize:11, color:C.textMuted, marginTop:3 }}>{t.fireCalc.barista.hrsRecovered}</div>
                    <div style={{ fontSize:10, color:C.coffeeGreen, marginTop:3 }}>{((Math.max(0,40-baristaHoursPerWeek)/40)*100).toFixed(0)}% {t.fireCalc.barista.ofFullTime}</div>
                  </div>
                  <div style={{ background:C.surface, borderRadius:10, padding:"12px 14px", textAlign:"center" }}>
                    <div style={{ fontSize:10, color:C.textMuted, letterSpacing:1, marginBottom:4 }}>{t.fireCalc.barista.monthlyIncomeLabel}</div>
                    ...
                    <div style={{ fontSize:11, color:C.textMuted, marginTop:3 }}>{t.fireCalc.barista.grossPerMonth}</div>
                    <div style={{ fontSize:10, color:C.textMuted, marginTop:3 }}>{t.fireCalc.barista.targetApprox} €{baristaIncome}</div>
                  </div>
                </div>

                {/* Monthly Budget Thermometer */}
                <div style={{ fontSize:11, fontWeight:700, color:C.coffeeLight, marginBottom:8 }}>{t.fireCalc.barista.coverageTitle}</div>
                    ...
                    return (
                      <>
                        <div style={{ display:"flex", justifyContent:"space-between", fontSize:11, color:C.textMuted, marginBottom:6 }}>
                          <span>{t.fireCalc.barista.workIncomeLabel} <strong style={{ color:C.coffeeLight }}>€{workCovers}/mo ({workPct}%)</strong></span>
                          <span>{t.fireCalc.barista.portShareLabel} <strong style={{ color:C.coffeeGreen }}>€{portfolioCovers}/mo ({portPct}%)</strong></span>
                        </div>
                        <div style={{ height:22, borderRadius:11, background:C.border, overflow:"hidden", display:"flex" }}>
                          <div style={{ width:`${workPct}%`, background:`linear-gradient(90deg,${C.coffeeDark},${C.coffeeLight})`, borderRadius:"11px 0 0 11px", transition:"width 0.4s", display:"flex", alignItems:"center", justifyContent:"center", minWidth:workPct>15?40:0 }}>
                            {workPct>15 && <span style={{ fontSize:9, fontWeight:700, color:"#fff" }}>{t.fireCalc.barista.workTag}</span>}
                          </div>
                          <div style={{ width:`${portPct}%`, background:`linear-gradient(90deg,${C.coffeeGreen},${C.green})`, transition:"width 0.4s", display:"flex", alignItems:"center", justifyContent:"center", minWidth:portPct>15?40:0 }}>
                            {portPct>15 && <span style={{ fontSize:9, fontWeight:700, color:"#fff" }}>{t.fireCalc.barista.portTag}</span>}
                          </div>
                        </div>
                        <div style={{ fontSize:11, color:C.textMuted, textAlign:"center", marginTop:6 }}>{t.fireCalc.barista.totalCovered} {euro(total)}/mo</div>
                      </>
                    );
                  })()}
                </div>
                ...
                <InfoBox color={C.coffeeGreen}>
                  {t.fireCalc.barista.advantage} {t.fireCalc.barista.instead} {kilo(fireNum)}, {lang==="de"?"brauchst du nur":"you only need"} {kilo(baristaTarget)} — {t.fireCalc.barista.saving} {kilo(fireNum - baristaTarget)}. {t.fireCalc.barista.working} {baristaHoursPerWeek} {t.fireCalc.barista.hrsAt} €{baristaHourlyWage}/hr {t.fireCalc.barista.gives} {Math.max(0,40-baristaHoursPerWeek)} {t.fireCalc.barista.freedomSuffix}
                </InfoBox>
              </div>
            </Card>
            ...
            {/* ── OMY Syndrome Tool ── */}
            <Card title={t.fireCalc.omy.title} accent={C.orange} titleRight={<Tip>{t.fireCalc.omy.tip}</Tip>}>
              <InfoBox color={C.orange}>
                <strong>{t.fireCalc.omy.syndrome}</strong> {t.fireCalc.omy.syndromeDesc}
              </InfoBox>
              <div style={{ marginTop:14, overflowX:"auto" }}>
                <table style={{ width:"100%", borderCollapse:"collapse", fontSize:12 }}>
                  <thead><tr style={{ background:C.surface }}>
                    {[t.fireCalc.omy.headers.extra, t.fireCalc.omy.headers.portfolio, t.fireCalc.omy.headers.failRate, t.fireCalc.omy.headers.improvement, t.fireCalc.omy.headers.marginal, t.fireCalc.omy.headers.verdict].map(h => (
                      ...
                      return (
                        <tr key={i} style={{ background:isBase?C.gold+"08":dimRet?C.red+"05":"transparent", borderLeft:`3px solid ${isBase?C.gold:dimRet?C.orange:"transparent"}` }}>
                          ...
                          <td style={{ padding:"8px 10px", textAlign:"right", color:dimRet?C.red:row.marginalGain>3?C.green:C.gold, fontFamily:C.mono, fontSize:11 }}>
                            {i===0?t.fireCalc.omy.baseline:row.marginalGain.toFixed(1)+t.fireCalc.omy.lessRisk}
                          </td>
                          <td style={{ padding:"8px 10px", textAlign:"right" }}>
                            <span style={{ background:isBase?C.gold+"22":dimRet?C.red+"15":C.green+"15", color:isBase?C.gold:dimRet?C.orange:C.green, borderRadius:6, padding:"2px 8px", fontSize:10, fontWeight:700 }}>
                              {isBase?t.ui.fireNow:(dimRet?t.ui.diminishing:t.ui.worthIt)}
                            </span>
                          </td>
                        </tr>
                      );
              ...
              <InfoBox color={C.orange} style={{ marginTop:14 }}>
                {t.fireCalc.omy.insight} ({omyData[0]?.failRate40 - (omyData[1]?.failRate40||0)}% {lang==="de"?"Verbesserung":"improvement"}). {lang==="de"?`Ab Jahr ${omyData.findIndex(r=>r.marginalGain < 1) || 4} bringt jedes Extra-Jahr weniger als 1% zusätzliche Sicherheit.`:`By Year ${omyData.findIndex(r=>r.marginalGain < 1) || 4}, each extra year buys less than 1% additional safety.`} <strong>{t.fireCalc.omy.tradingLife}</strong>
              </InfoBox>
            </Card>
          </div>
        )}
        ...
        {tab === "compare" && (
          <div>
            <Card title={t.compare.title} accent={C.gold} titleRight={<Tip>{t.compare.tip}</Tip>}>
              <div style={{ overflowX:"auto" }}>
                <table style={{ width:"100%", borderCollapse:"collapse", fontSize:13 }}>
                  <thead><tr style={{ background:C.surface }}>
                    {[t.compare.headers.type, t.compare.headers.spend, t.compare.headers.target, t.compare.headers.year, t.compare.headers.age, t.compare.headers.yearsAway, t.compare.headers.status].map(h => (
                    ...
                    {[
                      ...
                      return (
                        <tr key={row.key} style={{ background:done?row.color+"08":spendMode===row.key?C.gold+"05":"transparent", borderLeft:`3px solid ${done?row.color:spendMode===row.key?C.gold:"transparent"}` }}>
                          ...
                          <td style={{ padding:"10px 14px", textAlign:"right", color:done?C.green:C.text, fontFamily:C.mono }}>{done?t.compare.doneNow:yr||"2040+"}</td>
                          <td style={{ padding:"10px 14px", textAlign:"right", color:C.textSec, fontFamily:C.mono }}>{done?age:ageAtFire||"—"}</td>
                          <td style={{ padding:"10px 14px", textAlign:"right", color:done?C.green:C.gold, fontFamily:C.mono }}>{done?t.compare.done:yearsAway?`${yearsAway} ${t.ui.yearsAway}`:"—"}</td>
        ...
        {tab === "withdrawal" && (
          <div>
            ...
            <Card title={t.withdrawal.sorr.title} accent={C.red}>
              <InfoBox color={C.red}>{t.withdrawal.sorr.warning}</InfoBox>
              <div style={{ height:12 }} />
              <ResponsiveContainer width="100%" height={220}>
                <LineChart data={seqData} margin={{ left:0, right:10 }}>
                  ...
                  <Line dataKey="Lucky (Good Start)" stroke={C.green} strokeWidth={2.5} dot={false} name={t.withdrawal.sorr.lucky} />
                  <Line dataKey="Unlucky (Bad Start)" stroke={C.red} strokeWidth={2.5} dot={false} name={t.withdrawal.sorr.unlucky} />
                </LineChart>
              </ResponsiveContainer>
            </Card>

            <Card title={t.withdrawal.failureRates.title} accent={C.red}>
              <Slider label={t.withdrawal.failureRates.swrLabel} value={swr} min={3} max={5} step={0.1} onChange={setSwr} format={v=>`${v.toFixed(1)}%`} hint={`${lang==="de"?"Multiplikator":"Multiplier"}: ×${(100/swr).toFixed(1)} · ${lang==="de"?"FIRE-Ziel":"FIRE target"}: ${kilo(fireNum)}`} />
              <G2>
                <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:8 }}>
                  {[20,30,40,50].map(yrs => {
                    ...
                    return (
                      <div key={yrs} style={{ background:C.surface, border:`1px solid ${fr<=10?C.green:fr<=20?C.gold:C.red}33`, borderRadius:12, padding:"12px", textAlign:"center" }}>
                        <div style={{ fontSize:10, color:C.textMuted, letterSpacing:1 }}>{yrs}-{lang==="de"?"JAHRE":"YEAR"}</div>
                        <div style={{ fontSize:28, fontWeight:700, color:fr<=10?C.green:fr<=20?C.gold:C.red, fontFamily:C.mono }}>{fr}%</div>
                        <div style={{ fontSize:11, color:C.textMuted }}>
                          {fr<=5?t.withdrawal.failureRates.safe:fr<=10?t.withdrawal.failureRates.ok:fr<=20?t.withdrawal.failureRates.caution:t.withdrawal.failureRates.risky}
                        </div>
                ...
                <div>
                  <InfoBox color={C.blue}>
                    💡 {lang==="de"
                      ? `Bei vollem FIRE (${kilo(fireNum)}), Entnahme von genau ${swr.toFixed(1)}%/Jahr = ${euro(Math.round(fireNum*swr/100/12))}/Mo. Historische Ausfallrate über 40 Jahre: `
                      : `At full FIRE (${kilo(fireNum)}), withdrawing exactly ${swr.toFixed(1)}%/yr = ${euro(Math.round(fireNum*swr/100/12))}/mo. Historical failure rate over 40 years: `}
                    <strong>{failRateFromSWR(swr,40)}%</strong>. {lang==="de"?"Das bedeutet ~":"That means ~"}{100-failRateFromSWR(swr,40)}% {lang==="de"?"der historischen Szenarien sind erfolgreich.":"of historical scenarios succeed."}<br/><br/>
                    {lang==="de"?"Dynamische Ausgaben (20% Kürzung in Crash-Jahren) reduziert dies auf nahezu null.":"Dynamic spending (cut 20% in crash years) reduces this to near-zero."}
                  </InfoBox>
                  <div style={{ marginTop:10, background:C.coffeeGreen+"15", border:`1px solid ${C.coffeeGreen}44`, borderRadius:10, padding:"12px 14px" }}>
                    <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:6 }}>
                      <div>
                        <div style={{ fontSize:12, fontWeight:700, color:C.coffeeLight }}>{t.withdrawal.failureRates.safetyValve.title}</div>
                        <div style={{ fontSize:10, color:C.textMuted }}>{t.withdrawal.failureRates.safetyValve.desc}</div>
                      </div>
                      <div onClick={() => setShowSafetyBuffer(!showSafetyBuffer)}
                        ...
                        {showSafetyBuffer?t.ui.on:t.ui.off}
                      </div>
                    </div>
                    {showSafetyBuffer && (
                      <div style={{ fontSize:11, color:C.textSec, lineHeight:1.7 }}>
                        {lang==="de"?"Bei":"At"} €{baristaHourlyWage}/hr · 5 {lang==="de"?"Extra-Std./Woche":"extra hrs/wk"} = +{euro(Math.round(safetyExtra5hrsIncome))}/mo. {t.withdrawal.failureRates.safetyValve.suffix} <strong>{t.withdrawal.failureRates.safetyValve.baristaBeats}</strong>
                      </div>
                    )}
                  </div>
                </div>
            ...
            <Card title={t.withdrawal.gk.title} accent={C.teal}
              titleRight={<Tip>{t.withdrawal.gk.tip}</Tip>}>
              <InfoBox color={C.teal}>{t.withdrawal.gk.infoBox}</InfoBox>
              <div style={{ marginTop:14 }}>
                <G2>
                  <div>
                    <Slider label={t.withdrawal.gk.floorLabel} value={gkFloor} min={60} max={95} step={5} onChange={setGkFloor} format={v=>`${v}% = ${euro(spending*v/100)}/mo`} color={C.red} hint={t.withdrawal.gk.floorHint} />
                    <Slider label={t.withdrawal.gk.ceilLabel} value={gkCeil} min={105} max={150} step={5} onChange={setGkCeil} format={v=>`${v}% = ${euro(spending*v/100)}/mo`} color={C.green} hint={t.withdrawal.gk.ceilHint} />
                  </div>
                  <G3>
                    <Box small label={t.withdrawal.gk.boxes.floor} value={euro(spending*gkFloor/100)} sub={t.withdrawal.gk.boxes.floorSub} color={C.red} />
                    <Box small label={t.withdrawal.gk.boxes.base} value={euro(spending)} sub={t.withdrawal.gk.boxes.baseSub} color={C.gold} />
                    <Box small label={t.withdrawal.gk.boxes.ceil} value={euro(spending*gkCeil/100)} sub={t.withdrawal.gk.boxes.ceilSub} color={C.green} />
                    <Box small label={t.withdrawal.gk.boxes.vs} value={lang==="de"?"Höhere Überlebensrate":"Higher survival"} sub={t.withdrawal.gk.boxes.vsSub} color={C.teal} />
                  </G3>
                </G2>
              </div>
              ...
              <div style={{ marginTop:16 }}>
                <div style={{ fontSize:11, color:C.textMuted, marginBottom:8 }}>{t.withdrawal.gk.chartDesc}</div>
                ...
                <div style={{ display:"flex", gap:16, justifyContent:"center", marginTop:8, flexWrap:"wrap" }}>
                  {[{c:C.teal,l:t.withdrawal.gk.legends.gk},{c:C.red,l:t.withdrawal.gk.legends.fixed},{c:C.gold,l:t.withdrawal.gk.legends.spend}].map(l=>(
              ...
              <InfoBox color={C.teal} style={{ marginTop:14 }}>
                <strong>{t.withdrawal.gk.why}</strong> {t.withdrawal.gk.whyDesc}
              </InfoBox>
            </Card>
          </div>
        )}
        ...
        {tab === "budget" && (
          <div>
            <Card title={t.budget.title} accent={C.blue} titleRight={<Tip>{t.budget.tip}</Tip>}>
              <div style={{ marginBottom:16 }}>
              ...
              <div style={{ display:"flex", gap:8, flexWrap:"wrap", marginBottom:16 }}>
                <input placeholder={t.budget.categoryPlaceholder} value={newBudget.label} onChange={e => setNewBudget({...newBudget,label:e.target.value})}
                ...
                <input type="number" placeholder={t.budget.amountPlaceholder} value={newBudget.amount} onChange={e => setNewBudget({...newBudget,amount:Number(e.target.value)})}
                ...
                <button onClick={() => { if(newBudget.label){ setBudgetItems(prev=>[...prev,{...newBudget,id:Date.now()}]); setNewBudget({label:"",amount:0,cat:"Other",icon:"💶"}); }}}
                  style={{ background:C.blue, border:"none", borderRadius:8, padding:"8px 14px", color:"#fff", fontWeight:700, cursor:"pointer", fontFamily:C.font, fontSize:12 }}>{t.ui.add}</button>
              </div>

              <div style={{ background:C.surface, border:`1px solid ${C.gold}33`, borderRadius:12, padding:"16px" }}>
                <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:12 }}>
                  <span style={{ fontSize:16, fontWeight:700, color:C.text }}>{t.budget.totalLabel}</span>
                ...
                <div style={{ display:"grid", gridTemplateColumns:"repeat(3,1fr)", gap:8, marginTop:14 }}>
                  <div style={{ textAlign:"center" }}>
                    <div style={{ fontSize:11, color:C.textMuted }}>{t.budget.annual}</div>
                    <div style={{ fontSize:16, fontWeight:700, color:C.gold, fontFamily:C.mono }}>{euro(totalBudget*12)}</div>
                  </div>
                  <div style={{ textAlign:"center" }}>
                    <div style={{ fontSize:11, color:C.textMuted }}>{t.budget.fireTarget.replace("{mult}",legacyMult.toFixed(1))}</div>
                    <div style={{ fontSize:16, fontWeight:700, color:C.gold, fontFamily:C.mono }}>{kilo(totalBudget*12*legacyMult)}</div>
                  </div>
                  <div style={{ textAlign:"center" }}>
                    <div style={{ fontSize:11, color:C.textMuted }}>{t.budget.fireYearLabel}</div>
                ...
                <div style={{ marginTop:14, paddingTop:14, borderTop:`1px solid ${C.border}` }}>
                  <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center" }}>
                    <div>
                      <div style={{ fontSize:12, fontWeight:700, color:useBudgetAsSpending?C.green:C.textSec }}>
                        {useBudgetAsSpending ? t.budget.useBudgetActive : t.budget.useBudgetLabel}
                      </div>
                      <div style={{ fontSize:10, color:C.textMuted, marginTop:2 }}>
                        {useBudgetAsSpending
                          ? `${lang==="de"?"Alle Tabs verwenden jetzt":"All tabs now use"} €${totalBudget}/mo ${lang==="de"?"statt des":"instead of the"} "${spendMode}" ${lang==="de"?"Presets":"preset"} (€${spendMap[spendMode]}/mo)`
                          : `${lang==="de"?`Aktuell "${spendMode}"-Preset: €${spendMap[spendMode]}/mo`:`Currently using "${spendMode}" preset: €${spendMap[spendMode]}/mo`}`}
                      </div>
                    </div>
                    <div onClick={() => setUseBudgetAsSpending(!useBudgetAsSpending)}
                      ...
                      {useBudgetAsSpending?t.ui.on:t.ui.off}
                    </div>
                  </div>
                  {useBudgetAsSpending && totalBudget !== spendMap[spendMode] && (
                    <div style={{ marginTop:8, fontSize:11, color:C.textSec, background:C.green+"10", border:`1px solid ${C.green}22`, borderRadius:8, padding:"8px 12px" }}>
                      {t.budget.overrideInfo.replace("{amount}",totalBudget).replace('"{mode}"',`"${spendMode}"`).replace("{target}",kilo(totalBudget*12*legacyMult))}
                    </div>
                  )}
                </div>
              </div>
            ...
            <InfoBox color={useBudgetAsSpending ? C.green : C.blue}>
              {useBudgetAsSpending
                ? t.budget.useBudgetActive+` €${totalBudget}/mo. ${lang==="de"?"FIRE-Ziel":"FIRE target"}: ${kilo(totalBudget*12*legacyMult)}.`
                : `💡 ${lang==="de"?"Dein berechnetes Budget ist":"Your calculated budget is"} €${totalBudget}/mo (${lang==="de"?"FIRE-Ziel":"FIRE target"}: ${kilo(totalBudget*12*legacyMult)}). ${lang==="de"?`Aktiviere "Budget verwenden" oben.`:`Toggle "Use This Budget" above.`}`}
            </InfoBox>
          </div>
        )}
        ...
        {tab === "travel" && (
          <div>
            <Card title={t.travel.title} accent={C.teal} titleRight={<Tip>{lang==="de"?"Lege dein Jahres-Reisebudget und Komfortpräferenz fest. Jeder Stil multipliziert die Basiskosten.":"Set your annual travel budget and comfort preference. Each style multiplies the base cost per destination."}</Tip>}>
              <Slider label={t.travel.budgetLabel} value={travelBudget} min={0} max={2000} step={25} onChange={setTravelBudget} format={v=>`€${v}/mo (€${v*12}/yr)`} color={C.teal} hint={lang==="de"?"Im Budget-Tab einbeziehen":"This should be included in your Budget tab total"} />
              <div style={{ marginBottom:16 }}>
                <div style={{ fontSize:12, color:C.textSec, marginBottom:10 }}>{t.travel.styleLabel}</div>
                <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(130px,1fr))", gap:8 }}>
                  {[
                    { key:"backpacker", label:lang==="de"?"🎒 Backpacker":"🎒 Backpacker", mult:0.5, desc:lang==="de"?"Hostels, Streetfood, Nachtbusse":"Hostels, street food, overnight buses", color:C.green },
                    { key:"budget",     label:lang==="de"?"🏨 Budget":"🏨 Budget",         mult:0.8, desc:lang==="de"?"Gästehäuser, lokale Restaurants":"Guesthouses, local restaurants", color:C.cyanLight },
                    { key:"standard",   label:lang==="de"?"⚖️ Standard":"⚖️ Standard",     mult:1.0, desc:lang==="de"?"3★ Hotel, Mix aus auswärts essen":"3★ hotels, mix of eating out", color:C.gold },
                    { key:"comfort",    label:lang==="de"?"🛋️ Komfort":"🛋️ Comfort",       mult:1.6, desc:lang==="de"?"4★ Hotel, gute Restaurants":"4★ hotels, good restaurants", color:C.orange },
                    { key:"luxury",     label:lang==="de"?"✨ Luxus":"✨ Luxury",           mult:3.0, desc:lang==="de"?"5★ Resorts, Private Transfers":"5★ resorts, private transfers", color:C.pink },
                  ].map(s => (
              ...
              <G3>
                <Box small label={lang==="de"?"Jahresbudget":"Annual budget"} value={euro(travelAnnual)} sub={lang==="de"?"für alle Reisen":"for all travel"} color={C.teal} />
                <Box small label={lang==="de"?"Stil-Multiplikator":"Style multiplier"} value={`×${[{key:"backpacker",mult:0.5},{key:"budget",mult:0.8},{key:"standard",mult:1.0},{key:"comfort",mult:1.6},{key:"luxury",mult:3.0}].find(s=>s.key===travelStyle)?.mult||1}`} sub={lang==="de"?"Kostenmultiplikator":"cost multiplier"} color={C.cyanLight} />
                <Box small label={lang==="de"?"Effektive Tage/Jahr":"Effective days/yr"} value={`~${Math.round(travelAnnual/(70*([{key:"backpacker",mult:0.5},{key:"budget",mult:0.8},{key:"standard",mult:1.0},{key:"comfort",mult:1.6},{key:"luxury",mult:3.0}].find(s=>s.key===travelStyle)?.mult||1)))} ${t.travel.daysLabel}`} sub={lang==="de"?"bei deinem Stil":"at your style"} color={C.gold} />
                <Box small label={lang==="de"?"FIRE-Ziel Auswirkung":"FIRE target impact"} value={kilo(travelBudget*12*legacyMult)} sub={lang==="de"?"addiert zum Ziel":"this adds to target"} color={C.orange} />
              </G3>
            </Card>

            <Card title={lang==="de"?"Wohin kannst du und wie lange?":"Where Can You Go & For How Long?"} accent={C.teal}>
              <div style={{ fontSize:12, color:C.textMuted, marginBottom:12 }}>
                {lang==="de"?"Basiskosten angepasst für":"Base costs adjusted for"} <strong style={{ color:C.teal }}>{travelStyle}</strong> {lang==="de"?"Reisestil":"travel style"}
              </div>
              <div style={{ display:"flex", flexDirection:"column", gap:8 }}>
                    ...
                    <div key={dest.region} style={{ background:C.surface, border:`1px solid ${daysPerYear>=14?col+"44":C.border}`, borderRadius:12, padding:"14px 16px" }}>
                      <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start", marginBottom:8 }}>
                        ...
                        <div style={{ textAlign:"right" }}>
                          <div style={{ fontSize:11, color:C.textMuted }}>€{effectiveCost}/{t.travel.daysLabel} ({travelStyle})</div>
                          <div style={{ fontSize:16, fontWeight:700, color:daysPerYear>=7?col:C.textMuted, fontFamily:C.mono }}>{daysPerYear} {t.travel.daysLabel}</div>
                          <div style={{ fontSize:11, color:C.textMuted }}>{weeksPerYear} {t.travel.weeksLabel}</div>
                        </div>
                      </div>
                      <ProgressBar v={barW} max={100} color={daysPerYear>=14?col:C.textMuted} h={5} />
                      {daysPerYear < 7 && <div style={{ fontSize:11, color:C.red, marginTop:4 }}>{t.travel.tooLow.replace("{style}",travelStyle)}</div>}
                      {daysPerYear >= 30 && <div style={{ fontSize:11, color:col, marginTop:4 }}>{t.travel.fullMonth}</div>}
                      {daysPerYear >= 90 && <div style={{ fontSize:11, color:col, marginTop:2 }}>{t.travel.baseSelf}</div>}
                    </div>
                  );
                })}
              </div>
            ...
            {spendMode === "nomad" && (
              <Card title={t.travel.nomadTitle} accent={C.teal}>
                <InfoBox color={C.teal}>
                  <strong>Nomad FIRE</strong> {lang==="de"?"ist Geo-Arbitrage: Einkommen in Euro verdienen/entnehmen, in Ländern leben wo Kosten 3-5× niedriger sind. €700/Monat in Wien deckt nur Grundlagen. Dieselben €700/Monat in Chiang Mai (Thailand), Tbilisi (Georgien) oder Medellín (Kolumbien) decken einen sehr":"is geo-arbitrage: earn or withdraw income in Euros while living in countries where costs are 3-5x lower. €700/month in Vienna covers only basics. The same €700/month in Chiang Mai, Tbilisi, or Medellín covers a very"} <strong>{t.travel.comfortableLifestyle}</strong>.
                </InfoBox>
                <div style={{ marginTop:14 }}>
                  <G3>
                    {[
                      { city:"Chiang Mai 🇹🇭", cost:700, desc:lang==="de"?"Digitaler Nomaden-Hub, tolle Küche, Tempel":"Digital nomad hub, great food, temples" },
                      { city:"Tbilisi 🇬🇪",   cost:750, desc:lang==="de"?"Freie Visa, guter Wein, EU-nah":"Free visas, great wine, EU proximity" },
                      { city:"Medellín 🇨🇴",  cost:800, desc:lang==="de"?"Ewiger Frühling, lebendig, günstig":"Spring eternal, vibrant, affordable" },
                      { city:"Lissabon 🇵🇹",  cost:1400, desc:lang==="de"?"EU, englischfreundlich, Atlantikküste":"EU, English-friendly, Atlantic coast" },
                      { city:"Budapest 🇭🇺",  cost:900, desc:lang==="de"?"EU, nah an Österreich, exzellente Kultur":"EU, close to Austria, excellent culture" },
                      { city:"Tbilisi 🇬🇪",   cost:750, desc:lang==="de"?"1-Jahr-Visum, EU-Zeitzone, niedrige Steuer":"1yr visa, EU timezone, low tax" },
                    ].map(c => (
                      <div key={c.city} style={{ background:C.surface, border:`1px solid ${C.teal}33`, borderRadius:10, padding:"12px" }}>
                        ...
                        <div style={{ fontSize:11, color:C.textMuted }}>{t.travel.comfortableLifestyle}</div>
                      </div>
                    ))}
                  </G3>
                </div>
        ...
        {tab === "life" && (
          <div>
            <Card title={t.life.eventTitle} accent={C.pink}>
              <div style={{ marginBottom:14 }}>
                ...
                {events.length === 0 && <div style={{ fontSize:13, color:C.textMuted, textAlign:"center", padding:"12px" }}>{t.life.noEvents}</div>}
              </div>
              <div style={{ display:"flex", gap:8, flexWrap:"wrap" }}>
                <input placeholder={t.life.evtPlaceholder} value={newEvt.label} onChange={e => setNewEvt({...newEvt,label:e.target.value})}
                ...
                <input type="number" placeholder={t.life.yearPlaceholder} value={newEvt.year} onChange={e => setNewEvt({...newEvt,year:Number(e.target.value)})}
                ...
                <input type="number" placeholder={t.life.costPlaceholder} value={newEvt.cost} onChange={e => setNewEvt({...newEvt,cost:Number(e.target.value)})}
                ...
                <button onClick={() => { if(newEvt.label){setEvents([...events,{...newEvt,id:Date.now()}]);setNewEvt({label:"",year:currentYear+3,cost:5000}); }}}
                  style={{ background:C.pink, border:"none", borderRadius:8, padding:"8px 14px", color:"#fff", fontWeight:700, cursor:"pointer", fontFamily:C.font, fontSize:12 }}>{t.ui.add}</button>
              </div>
            </Card>

            <Card title={t.life.coupleTitle} accent={C.green}>
              <Tag on={coupleMode} onClick={() => setCoupleMode(!coupleMode)} color={C.green}>{t.life.enableCouple}</Tag>
              {coupleMode && (
                <div style={{ marginTop:14 }}>
                  <Slider label={t.life.partnerSavings} value={partnerSavings} min={0} max={3000} step={50} onChange={setPartnerSavings} format={v=>`€${v}/mo`} color={C.green} />
                  <Slider label={t.life.partnerPortfolio} value={partnerPortfolio} min={0} max={500000} step={1000} onChange={setPartnerPortfolio} format={v=>kilo(v)} color={C.green} />
                  <G3>
                    <Box small label={t.life.combinedPortfolio} value={kilo(startPort)} color={C.green} />
                    <Box small label={t.life.combinedSavings} value={`€${totalSavings}`} color={C.green} />
                    <Box small label={t.life.combinedFireYear} value={fireYear||"2040+"} color={C.gold} />
                  </G3>
                  <InfoBox color={C.green} style={{ marginTop:12 }}>{t.life.coupleInfo}</InfoBox>
                </div>
              )}
            </Card>

            <Card title={t.life.ptTitle} accent={C.cyan}>
              <div style={{ position:"relative", marginLeft:18 }}>
                <div style={{ position:"absolute", left:-14, top:0, bottom:0, width:2, background:C.border }} />
                {[
                  { l:t.life.ptFull,    days:5, yr:currentYear, inc:monthlySavings*2+1000 },
                  { l:t.life.pt4d,      days:4, yr:currentYear+Math.round((fireYear||currentYear+10)-currentYear)*0.4, inc:Math.round((monthlySavings*2+1000)*0.8) },
                  { l:t.life.pt3d,      days:3, yr:currentYear+Math.round((fireYear||currentYear+10)-currentYear)*0.6, inc:Math.round((monthlySavings*2+1000)*0.6) },
                  { l:t.life.ptBarista, days:2, yr:baristaYear||currentYear+8, inc:baristaIncome },
                  { l:t.life.ptFire,    days:0, yr:fireYear||currentYear+12, inc:0 },
                ].map((s,i) => {
                    ...
                    <div key={i} style={{ position:"relative", marginBottom:16, paddingLeft:18 }}>
                      ...
                      <div style={{ background:C.surface, border:`1px solid ${s.days===0?C.gold+"44":C.border}`, borderRadius:12, padding:"12px 16px" }}>
                        <div style={{ display:"flex", justifyContent:"space-between", marginBottom:6 }}>
                          ...
                          <span style={{ fontSize:12, color:s.days===0?C.gold:C.cyan, fontFamily:C.mono }}>{s.inc>0?euro(s.inc)+"/mo":t.ui.portfolioOnly}</span>
                        </div>
                        <div style={{ display:"flex", gap:4, marginBottom:6 }}>
                          {[1,2,3,4,5].map(d=><div key={d} style={{ width:14, height:14, borderRadius:3, background:d<=s.days?C.cyan:C.border }} />)}
                          <span style={{ fontSize:11, color:C.textMuted, marginLeft:8, lineHeight:"14px" }}>{s.days===0?t.life.freeLabel:`${s.days} ${t.life.daysWk}`}</span>
                        </div>
                        <div style={{ fontSize:11, color:C.textMuted }}>{t.life.portfolioLabel} <span style={{ color:C.textSec, fontFamily:C.mono }}>{euro(sp)}</span></div>
                      </div>
                    </div>
                  );
                })}
        ...
        {tab === "austria" && (
          <div>
            <InfoBox color={C.gold}>{t.austria.overviewBox}</InfoBox>
        ...
        {tab === "taxoptimizer" && (
          <div>
            ...
            {(() => {
              ...
              return (
                <G3>
                  <Box label={t.taxoptimizer.boxes.gross30} value={kilo(yr30gross)} sub={t.taxoptimizer.boxes.gross30Sub} color={C.gold} />
                  <Box label={t.taxoptimizer.boxes.afterDrag} value={kilo(yr30taxed)} sub={t.taxoptimizer.boxes.afterDragSub} color={taxHarvesting||taxRegelbest?C.green:C.orange} />
                  <Box label={t.taxoptimizer.boxes.spendable} value={kilo(yr30spend)} sub={t.taxoptimizer.boxes.spendableSub} color={taxRegelbest?C.cyan:C.blue} />
                  <Box label={t.taxoptimizer.boxes.totalTax} value={kilo(taxCost)} sub={t.taxoptimizer.boxes.totalTaxSub} color={C.red} />
                  <Box label={t.taxoptimizer.boxes.taxPct} value={`${yr30gross>0?((taxCost/yr30gross)*100).toFixed(1):"0"}%`} sub={t.taxoptimizer.boxes.taxPctSub} color={C.red} />
                  <Box label={t.taxoptimizer.boxes.strategy} value={taxRegelbest?t.taxoptimizer.strategies.zero:taxHarvesting?t.taxoptimizer.strategies.harvesting:t.taxoptimizer.strategies.standard} sub={t.taxoptimizer.boxes.strategySub} color={taxRegelbest?C.cyan:taxHarvesting?C.green:C.textSec} />
                </G3>
              );
            })()}

            {/* Main tax drag chart */}
            <Card title={t.taxoptimizer.dragTitle} accent={C.red} style={{ marginTop:14 }}>
              ...
              <div style={{ display:"flex", gap:14, justifyContent:"center", marginTop:8, flexWrap:"wrap" }}>
                {[{c:C.gold,l:t.taxoptimizer.dragLegend.gross},{c:C.orange,l:t.taxoptimizer.dragLegend.afterDrag},{c:C.blue,l:t.taxoptimizer.dragLegend.spendable}].map(l=>(
                  <div key={l.l} style={{ display:"flex", alignItems:"center", gap:5, fontSize:11, color:C.textSec }}>
                    <div style={{ width:12, height:4, borderRadius:2, background:l.c }} />{l.l}
                  </div>
                ))}
            ...
            <Card title={t.taxoptimizer.regelTitle} accent={C.cyan}>
              <G2>
                <div>
                  <div style={{ background:C.cyan+"12", border:`1px solid ${C.cyan}33`, borderRadius:12, padding:"16px", marginBottom:12 }}>
                    <div style={{ fontSize:13, fontWeight:700, color:C.cyanLight, marginBottom:8 }}>{t.taxoptimizer.regelHowTo}</div>
                    {t.taxoptimizer.regelSteps.map((s,i) => (
                  ...
                  <InfoBox color={C.cyan}>
                    🎉 <strong>{lang==="de"?"Reale Auswirkung":"Real impact"}:</strong> {lang==="de"
                      ? `Bei €${euro(spending)}/Mo Ausgaben mit Regelbesteuerungsoption könntest du über 30 Jahre `
                      : `At €${euro(spending)}/mo spending with Regelbesteuerungsoption, you could save `}
                    <strong>{kilo((taxDragData[29]?.["Gross Portfolio"]||0) - (taxDragData[29]?.["Real Spendable"]||0))}</strong>
                    {lang==="de"?" an Steuern sparen — gegenüber Standard-KESt.":" in taxes over 30 years compared to paying standard KeSt."}
                  </InfoBox>
                </div>
                <div>
                  <div style={{ fontSize:11, color:C.textMuted, marginBottom:8, textTransform:"uppercase", letterSpacing:1 }}>{t.taxoptimizer.thresholdsTitle}</div>
                  <div style={{ display:"flex", flexDirection:"column", gap:6 }}>
                    {[
                      { label:lang==="de"?"Steuerfreigrenze":"Tax-free threshold",             value:"€13,539/yr", color:C.green,  note:lang==="de"?"Regelbesteuerungsoption → 0% KESt":"Regelbesteuerungsoption applies → 0% KeSt" },
                      { label:lang==="de"?"25% Einkommensteuer-Stufe":"25% income tax bracket", value:"€13,539–18,000", color:C.gold, note:lang==="de"?"Besser als 27,5% KESt":"Still much better than 27.5% KeSt" },
                      { label:lang==="de"?"35%-Stufe":"35% bracket",                           value:"€18,000–31,000", color:C.orange, note:lang==="de"?"Regelbesteuerungsoption lohnt sich hier NICHT":"Regelbesteuerungsoption NOT worth it here" },
                      { label:lang==="de"?"Standard-KESt gilt":"Standard KeSt applies",         value:lang==="de"?"Über €31.000":"Above €31,000", color:C.red, note:lang==="de"?"27,5% Pauschalsteuer günstiger":"27.5% flat rate is better than personal rate" },
                      { label:lang==="de"?"Negativsteuer-Rückerstattung":"Negativsteuer refund", value:lang==="de"?"Unter €12.816/Jahr":"Under €12,816/yr", color:C.cyan, note:lang==="de"?"Bis zu €400 SV-Rückerstattung":"Up to €400 SV refund even without tax owed" },
                    ].map(row => (
        ...
        {tab === "realestate" && (
          <div>
            ...
            <div style={{ marginBottom:18 }}>
              <div style={{ fontSize:11, color:C.textMuted, letterSpacing:2, textTransform:"uppercase", marginBottom:10 }}>{lang==="de"?"Wohnsituation":"Housing Situation"}</div>
              <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(145px,1fr))", gap:8 }}>
                {(["none","own","invest","inherit","build"]).map(k => {
                  const m = t.re.modes[k];
                  const colorMap = { none:C.textSec, own:C.gold, invest:C.green, inherit:C.purple, build:C.orange };
                  const iconMap  = { none:"🏢", own:"🏠", invest:"💼", inherit:"🎁", build:"🏗️" };
                  const col = colorMap[k];
                  return (
                    <div key={k} onClick={() => setRePropMode(k)}
                      style={{ background:rePropMode===k?col+"18":C.card, border:`2px solid ${rePropMode===k?col:C.border}`, borderRadius:12, padding:"14px 12px", cursor:"pointer", transition:"all 0.15s" }}>
                      <div style={{ fontSize:22, marginBottom:6 }}>{iconMap[k]}</div>
                      <div style={{ fontSize:12, fontWeight:700, color:rePropMode===k?col:C.text, marginBottom:4 }}>{m.label}</div>
            ...
            {/* ── "None" / Renting mode ── */}
            {rePropMode === "none" && (
              <Card title={`🏢 ${lang==="de"?"Nur mieten / Nur ETF-Strategie":"Pure Renter / ETF-Only Strategy"}`} accent={C.textSec}>
                <InfoBox color={C.blue}>
                  {lang==="de"
                    ? "Du hast gewählt, keine Immobilie in deinen FIRE-Plan einzubeziehen. Alle Ersparnisse gehen direkt in ETFs. Das ist eine vollgültige Strategie — besonders in teuren Städten wo Kaufen oft schlechter abschneidet als Mieten + die Differenz investieren."
                ...
                <div style={{ marginTop:14 }}>
                  <Slider label={t.re.currentRent} value={reCurrentRent} min={0} max={3000} step={25} onChange={setReCurrentRent} format={v=>`€${v}/mo`} color={C.cyan} hint={lang==="de"?"Zur Darstellung deiner laufenden Wohnkosten im Fahrplan":"Used in the roadmap to show your ongoing housing cost"} />
                </div>
                <G3>
                  <Box small label={lang==="de"?"Jährl. Mietkosten":"Annual rent cost"} value={euro(reCurrentRent*12)} sub={lang==="de"?"pro Jahr":"per year"} color={C.textSec} />
                  <Box small label={lang==="de"?"FIRE-Ziel-Auswirkung":"FIRE target impact"} value={kilo(reCurrentRent*12*legacyMult)} sub={lang==="de"?"Miete im Ziel enthalten":"rent included in target"} color={C.gold} />
                  <Box small label={lang==="de"?"vs. Kaufen":"vs owning"} value={lang==="de"?"Keine Bindung":"No lock-in"} sub={lang==="de"?"volle Flexibilität":"full flexibility"} color={C.cyan} />
                </G3>
              </Card>
            )}
            ...
            {/* ── Inherit mode ── */}
            {rePropMode === "inherit" && (
              <Card title={t.re.inheritTitle} accent={C.purple}>
                <G2>
                  <div>
                    <Slider label={t.re.inheritValueLabel} value={reInheritedValue} min={50000} max={2000000} step={10000} onChange={setReInheritedValue} format={v=>euro(v)} color={C.purple} hint={t.re.inheritValueSub} />
                    <Slider label={t.re.maintenance} value={reMaintenance} min={0} max={1000} step={25} onChange={setReMaintenance} format={v=>`€${v}/mo`} color={C.orange} />
                    <Slider label={t.re.appreciation} value={reAppreciation} min={0} max={6} step={0.25} onChange={setReAppreciation} format={v=>`${v.toFixed(2)}%/yr`} color={C.teal} />
                    <Slider label={t.re.currentRent} value={reCurrentRent} min={0} max={3000} step={25} onChange={setReCurrentRent} format={v=>`€${v}/mo`} color={C.cyan} hint={t.re.rentHintInherit} />
                  </div>
                  <div>
                    <G3>
                      <Box small label={t.re.inheritValueLabel} value={euro(reInheritedValue)} sub={t.re.inheritValueSub} color={C.purple} />
                      <Box small label={lang==="de"?"Wert in 20 Jahren":"Value in 20 years"} value={euro(Math.round(reInheritedValue*Math.pow(1+reAppreciation/100,20)))} sub={t.re.inheritValue20ySub.replace("{pct}",reAppreciation)} color={C.teal} />
                      <Box small label={t.re.housingBenefit} value={`-${euro(reHousingBenefit)}/mo`} sub={t.re.housingBenefitSub} color={C.green} />
                      <Box small label={t.re.targetReducLabel} value={kilo(reHousingBenefit*12*legacyMult)} sub={t.re.targetReducSub} color={C.green} />
                      <Box small label={t.re.adjFireYearLabel} value={reFireYearAdj||"2040+"} sub={t.re.adjFireYearSub} color={reFireYearAdj&&fireYear&&reFireYearAdj<fireYear?C.green:C.gold} />
                      <Box small label={t.re.vsStandardLabel} value={reFireYearAdj&&fireYear?`${Math.abs(fireYear-reFireYearAdj)} ${t.re.vsStandardSub}`:"—"} color={C.green} />
                    </G3>
                    <InfoBox color={C.purple} style={{ marginTop:12 }}>
                      🎁 {lang==="de"
                        ? "Die österreichische Erbschaftsteuer (Erbschaftsteuer) wurde 2008 abgeschafft. Allerdings kann die Grunderwerbsteuer (GrESt, 3,5%) anfallen. Für direkte Erben (Ehegatte, Kinder, Enkel) wird GrESt vom reduzierten Grundstückswert berechnet — oft deutlich unter Marktwert. Notar konsultieren."
                        : "Austrian inheritance tax (Erbschaftsteuer) was abolished in 2008. However, Grunderwerbsteuer (3.5%) may apply when property is transferred. For direct family heirs, GrESt is calculated on a reduced 'Grundstückswert' — often significantly less than market value. Consult a Notar."}
                    </InfoBox>
                  </div>
                </G2>
              </Card>
            ...
            {/* ── Self-Build mode ── */}
            {rePropMode === "build" && (
              <Card title={t.re.buildTitle} accent={C.orange}>
                <G2>
                  <div>
                    <Slider label={t.re.buildLandLabel} value={reBuildLandCost} min={20000} max={500000} step={5000} onChange={setReBuildLandCost} format={v=>euro(v)} color={C.orange} hint={t.re.buildLandHint} />
                    <Slider label={t.re.buildCostLabel} value={reBuildCost} min={100000} max={1000000} step={10000} onChange={setReBuildCost} format={v=>euro(v)} color={C.gold} hint={t.re.buildCostHint} />
                    <Slider label={t.re.buildYearLabel} value={reBuildYear} min={currentYear+1} max={currentYear+15} step={1} onChange={setReBuildYear} format={v=>`${v} (in ${v-currentYear} yrs)`} color={C.teal} />
                  ...
                  <div>
                    <G3>
                      <Box small label={t.re.totalCostLabel} value={euro(reBuildCost+reBuildLandCost)} sub={t.re.totalCostSub} color={C.orange} />
                      <Box small label={t.re.benchmarkLabel} value={euro(rePropPrice)} sub={t.re.benchmarkSub} color={C.textSec} />
                      <Box small label={t.re.potSavingLabel} value={rePropPrice>reBuildCost+reBuildLandCost?euro(rePropPrice-(reBuildCost+reBuildLandCost)):(lang==="de"?"Benchmark →":"Set benchmark →")} sub={t.re.potSavingSub} color={C.green} />
                      <Box small label={t.re.monthlyMortgLabel} value={euro(reMortgagePayment)} sub={t.re.monthlyMortgSub} color={C.red} />
                      <Box small label={t.re.completionYearLabel} value={String(reBuildYear)} sub={`${lang==="de"?"Alter":"age"} ${reBuildYear-currentYear+age}`} color={C.teal} />
                      <Box small label={t.re.mortgageFreeLabel} value={String(rePayoffYear)} sub={`${lang==="de"?"Alter":"age"} ${rePayoffYear-currentYear+age}`} color={C.gold} />
                    </G3>
                    <div style={{ marginTop:10 }}>
                      <Slider label={lang==="de"?"Monatliche Instandhaltung nach Bau":"Monthly maintenance after build"} value={reMaintenance} min={0} max={1000} step={25} onChange={setReMaintenance} format={v=>`€${v}/mo`} color={C.orange} />
                      <Slider label={t.re.currentRent} value={reCurrentRent} min={0} max={3000} step={25} onChange={setReCurrentRent} format={v=>`€${v}/mo`} color={C.cyan} />
                    </div>
                    <InfoBox color={C.orange}>
                      🏗️ {lang==="de"
                        ? "Österr. Selbstbau-Tipps: Wohnbauförderung kann sehr großzügig sein (bis zu €30–80k in manchen Bundesländern). Auch Fertighäuser erwägen — bis zu 30% günstiger als Massivbau. 10–15% Kostenreserve einplanen."
                        : "Austrian self-build tips: Wohnbauförderung subsidies can be very generous for self-builds (up to €30–80k in some provinces). Also consider Fertighäuser (prefab) — up to 30% cheaper than Massivbau. Budget 10–15% contingency."}
                    </InfoBox>
                  </div>
                </G2>
              </Card>
            ...
            <Card title={`${rePropMode==="own"?"🏠":"💼"} ${t.re.title} — ${rePropMode==="own"?t.re.modeOwn:t.re.modeInvest}`} accent={rePropMode==="own"?C.gold:C.green}
              titleRight={<Tip>{rePropMode==="own"?t.re.inheritTip:t.re.investTip}</Tip>}>
              <G2>
                <div>
                  <Slider label={t.re.propPrice} value={rePropPrice} min={50000} max={1500000} step={5000} onChange={setRePropPrice} format={v=>euro(v)} color={rePropMode==="own"?C.gold:C.green} />
                  <Slider label={`${t.re.downPct} (${reDownPct}% = ${euro(reDownPayment)})`} value={reDownPct} min={5} max={60} step={1} onChange={setReDownPct} format={v=>`${v}%`} color={C.purple} hint={`${lang==="de"?"Kreditbetrag":"Loan amount"}: ${euro(reLoanAmount)}`} />
                  <Slider label={t.re.interestRate} value={reInterestRate} min={0.5} max={8} step={0.1} onChange={setReInterestRate} format={v=>`${v.toFixed(1)}%`} color={C.red} hint={lang==="de"?"Österr. Hypothekenzinsen 2024: ~3,0–4,5% fix":"Austrian mortgage rates 2024: ~3.0–4.5% fixed"} />
                  <Slider label={t.re.loanTerm} value={reLoanTerm} min={5} max={35} step={1} onChange={setReLoanTerm} format={v=>`${v} ${t.re.loanTermYrsLabel}`} color={C.blue} />
                </div>
                <div>
                  <Slider label={t.re.maintenance} value={reMaintenance} min={0} max={1000} step={25} onChange={setReMaintenance} format={v=>`€${v}/mo`} color={C.orange} hint={lang==="de"?"Typisch 0,5–1% des Immobilienwerts/Jahr":"Typically 0.5–1% of property value per year"} />
                  <Slider label={t.re.appreciation} value={reAppreciation} min={0} max={6} step={0.25} onChange={setReAppreciation} format={v=>`${v.toFixed(2)}%/yr`} color={C.teal} hint={lang==="de"?"Österreich Ø ~2–3%/Jahr historisch":"Austria avg ~2–3%/yr historically"} />
                  {rePropMode === "own" && (
                    <Slider label={t.re.currentRent} value={reCurrentRent} min={0} max={3000} step={25} onChange={setReCurrentRent} format={v=>`€${v}/mo`} color={C.cyan} hint={t.re.rentHintChange} />
                  )}
                  {rePropMode === "invest" && (
                    <>
                      <Slider label={t.re.monthlyRent} value={reMonthlyRent} min={0} max={5000} step={50} onChange={setReMonthlyRent} format={v=>`€${v}/mo`} color={C.green} />
                      <Slider label={t.re.taxRate} value={reRentalTaxRate} min={0} max={55} step={1} onChange={setReRentalTaxRate} format={v=>`${v}%`} color={C.orange} hint={lang==="de"?"AT: 25–50% je nach Einkommensklasse. AfA & Zinsen zuerst absetzbar.":"AT: 25–50% depending on income bracket. AfA & interest deductible first."} />
                    </>
                  )}
                </div>
              </G2>
            ...
            <Card title={t.re.mortgageTitle} accent={C.blue}>
              <G3>
                <Box small label={t.re.monthlyPayment} value={euro(reMortgagePayment)} sub="/month" color={C.red} />
                <Box small label={t.re.totalInterest} value={euro(Math.round(reTotalInterest))} sub={`${lang==="de"?"über":"over"} ${reLoanTerm} ${lang==="de"?"Jahre":"years"}`} color={C.orange} />
                <Box small label={t.re.payoffYear} value={`${rePayoffYear}`} sub={`${lang==="de"?"Alter":"age"} ${rePayoffYear - currentYear + age}`} color={C.gold} />
                <Box small label={lang==="de"?"Eigenkapital":"Down Payment"} value={euro(reDownPayment)} sub={lang==="de"?"Sofortiges Eigenkapital":"upfront equity"} color={C.purple} />
                <Box small label={lang==="de"?"Kreditbetrag":"Loan Amount"} value={euro(reLoanAmount)} sub={lang==="de"?"geliehen":"borrowed"} color={C.blue} />
                <Box small label={lang==="de"?"Gesamtkosten":"Total Cost"} value={euro(reEffectivePrice + Math.round(reTotalInterest))} sub={lang==="de"?"Preis + alle Zinsen":"price + all interest"} color={C.textSec} />
              </G3>
              ...
              <div style={{ marginTop:16, background:C.surface, borderRadius:12, padding:"14px 18px" }}>
                <div style={{ fontSize:11, color:C.textMuted, letterSpacing:2, textTransform:"uppercase", marginBottom:10 }}>
                  {rePropMode==="own"||rePropMode==="build"
                    ? (lang==="de"?"Monatliche Kosten: Kaufen vs. Mieten":"Monthly Cost: Buying vs. Renting")
                    : (lang==="de"?"Monatlicher Cashflow Anlageimmobilie":"Buy-to-Let Monthly Cashflow")}
                </div>
                {rePropMode === "own" ? (
                  <div style={{ display:"flex", flexDirection:"column", gap:8 }}>
                    {[
                      { l:lang==="de"?"Aktuelle Miete":"Your current rent",                       v:reCurrentRent, c:C.textSec },
                      { l:lang==="de"?"Kreditrate":"Mortgage payment",                             v:reMortgagePayment, c:C.red },
                      { l:lang==="de"?"Instandhaltung & Versicherung":"Maintenance & insurance",   v:reMaintenance, c:C.orange },
                      { l:lang==="de"?"Gesamtkosten Eigentum":"Total owning cost",                  v:reMortgagePayment+reMaintenance, c:C.gold, bold:true },
                      { l:lang==="de"?"Monatliche Differenz vs. Mieten":"Monthly delta vs renting", v:reMortgagePayment+reMaintenance-reCurrentRent, c:reMortgagePayment+reMaintenance>reCurrentRent?C.red:C.green, delta:true },
                    ].map(row => (
                  ...
                  <div style={{ display:"flex", flexDirection:"column", gap:8 }}>
                    {[
                      { l:lang==="de"?"Brutto-Mieteinnahmen":"Gross rental income",                                    v:reMonthlyRent, c:C.green },
                      { l:`${lang==="de"?"Einkommensteuer":"Income tax"} (~${reRentalTaxRate}%, ${lang==="de"?"nach Absetzbeträgen":"after deductions"})`, v:-Math.round(reRentalTax/12), c:C.red },
                      { l:lang==="de"?"AfA-Vorteil (monatlich)":"AfA benefit (monthly equiv.)",                         v:Math.round(reAfaAnnual/12), c:C.cyan, note:lang==="de"?"absetzbar":"deductible" },
                      { l:lang==="de"?"Kreditrate":"Mortgage payment",                                                   v:-reMortgagePayment, c:C.red },
                      { l:lang==="de"?"Instandhaltung & Versicherung":"Maintenance & insurance",                         v:-reMaintenance, c:C.orange },
                      { l:lang==="de"?"Monatlicher Netto-Cashflow":"Net monthly cashflow",                               v:reCashflow, c:reCashflow>=0?C.green:C.red, bold:true },
                    ].map(row => (
                      <div key={row.l} style={{ display:"flex", justifyContent:"space-between", borderBottom:`1px solid ${C.border}`, paddingBottom:6 }}>
            ...
            {rePropMode === "invest" && (
              <Card title={lang==="de"?"📈 Mietrendite & Österr. Steueranalyse":"📈 Rental Yield & Austrian Tax Analysis"} accent={C.green}
                titleRight={<Tip>{t.re.afaNote}</Tip>}>
                <G3>
                  <Box small label={t.re.grossYield} value={`${reGrossYield.toFixed(2)}%`} sub={lang==="de"?"vor Steuer & Kosten":"before tax & costs"} color={C.gold} />
                  <Box small label={t.re.netYield} value={`${reNetYield.toFixed(2)}%`} sub={lang==="de"?"nach allen Kosten & Steuern":"after all costs & tax"} color={reNetYield>=3?C.green:reNetYield>=2?C.gold:C.red} />
                  <Box small label={t.re.monthlyCashflow} value={`${reCashflow>=0?"+ ":""}${euro(reCashflow)}`} sub="/month net" color={reCashflow>=0?C.green:C.red} />
                  <Box small label="AfA" value={euro(reAfaAnnual)} sub={lang==="de"?"/Jahr absetzbar":"/year deductible"} color={C.cyan} />
                  <Box small label={lang==="de"?"Zinsabsetzbetrag Jahr 1":"Yr1 interest deduction"} value={euro(reYearOneInterest)} sub={lang==="de"?"absetzbar (Jahr 1)":"deductible (yr 1)"} color={C.cyan} />
                  <Box small label={lang==="de"?"Steuerpflichtiger Mietertrag":"Taxable rental income"} value={euro(reTaxableRental)} sub={lang==="de"?"/Jahr nach Absetzbeträgen":"/year after deductions"} color={reTaxableRental<100?C.green:C.gold} />
                </G3>
                <div style={{ marginTop:14 }}>
                  <InfoBox color={C.green}>
                    🇦🇹 {lang==="de"
                      ? `Österr. Vermietungs-Steuerstrategie: Absetzbeträge Jahr 1: AfA ${euro(reAfaAnnual)}/Jahr + Zinsen ${euro(reYearOneInterest)}/Jahr + Instandhaltung ${euro(reMaintenance*12)}/Jahr = ${euro(reAfaAnnual+reYearOneInterest+reMaintenance*12)} gesamt. ${reTaxableRental<=0?"Deine Absetzbeträge übersteigen die Bruttomiete — kein steuerpflichtiger Mietertrag in frühen Jahren! Vollkommen legal und in Österreich üblich.": `Steuerpflichtiger Ertrag = ${euro(reTaxableRental)}/Jahr → Steuer ≈ ${euro(reRentalTax)}/Jahr bei ${reRentalTaxRate}%.`} Hinweis: Veräußerungsgewinne unterliegen 30% ImmoESt.`
                      : `Austrian rental tax strategy: Deductible expenses in year 1: AfA ${euro(reAfaAnnual)}/yr + mortgage interest ${euro(reYearOneInterest)}/yr + maintenance ${euro(reMaintenance*12)}/yr = ${euro(reAfaAnnual+reYearOneInterest+reMaintenance*12)} total. ${reTaxableRental<=0?"Your deductions exceed gross rent — zero taxable rental income in early years! Completely legal and common in Austria.": `Taxable income = ${euro(reTaxableRental)}/yr → tax ≈ ${euro(reRentalTax)}/yr at ${reRentalTaxRate}%.`} Note: capital gains on sale are taxed at 30% ImmoESt.`}
                  </InfoBox>
                </div>
              </Card>
            )}

            {/* Equity chart and Buy-vs-Rent */}
            {(rePropMode === "own" || rePropMode === "invest" || rePropMode === "build") && (<div>
            <Card title={`🏗️ ${t.re.equityGrowth}`} accent={rePropMode==="own"||rePropMode==="build"?C.gold:C.green}
              titleRight={<Tip>{lang==="de"?"Balken = Eigenkapital (Wert minus Restkredit). Rote gestrichelte Linie = Restkredit. Lila = Immobilienwert.":"Bars = home equity (property value minus remaining loan). Red dashed = remaining loan. Purple = property value."}</Tip>}>
              <div style={{ fontSize:12, color:C.textMuted, marginBottom:12 }}>
                {lang==="de"?"Immobilienwert bei Abbezahlung":"Property value at payoff"} ({rePayoffYear}): <strong style={{ color:C.gold }}>{euro(Math.round(rePropPrice * Math.pow(1+reAppreciation/100, reLoanTerm)))}</strong>
                {" "}· {lang==="de"?"Eigenkapital bei Abbezahlung":"Total equity at payoff"}: <strong style={{ color:C.green }}>{euro(reMortgageSchedule[Math.min(reLoanTerm, reMortgageSchedule.length-1)]?.equity||0)}</strong>
              </div>
              <ResponsiveContainer width="100%" height={270}>
                <ComposedChart data={reMortgageSchedule.slice(0, Math.min(reLoanTerm+1, reMortgageSchedule.length))} margin={{ left:0, right:10 }}>
                  ...
                  <Tooltip content={<CT/>} />
                  <Bar dataKey="equity" fill="url(#eqGrad)" stroke={rePropMode==="own"?C.gold:C.green} strokeWidth={1} name={t.re.equity} radius={[3,3,0,0]} />
                  <Line dataKey="balance" stroke={C.red} strokeWidth={2} dot={false} name={lang==="de"?"Restkredit":"Remaining Loan"} strokeDasharray="5 3" />
                  <Line dataKey="propValue" stroke={C.purple} strokeWidth={2} dot={false} name={lang==="de"?"Immobilienwert":"Property Value"} />
                </ComposedChart>
              </ResponsiveContainer>
              <div style={{ display:"flex", gap:16, justifyContent:"center", marginTop:10, flexWrap:"wrap" }}>
                {[
                  { color:rePropMode==="own"?C.gold:C.green, label:t.re.equity },
                  { color:C.red,    label:lang==="de"?"Restkredit (gestrichelt)":"Remaining Loan (dashed)" },
                  { color:C.purple, label:lang==="de"?"Immobilienwert":"Property Value" },
                ].map(l => (
            ...
            <Card title={`⚖️ ${t.re.buyVsRentTitle}`} accent={C.purple}
              titleRight={<Tip>{lang==="de"?"Ausgezogene Linie = Gesamtvermögen mit Kauf. Gestrichelt = nur ETF. Keine Option ist immer besser — Wertsteigerung vs. ETF-Rendite ist der entscheidende Faktor.":"Solid = net worth if you buy. Dashed = rent and invest. Neither is always better — appreciation rate vs. ETF return is the key variable."}</Tip>}>
              <div style={{ fontSize:12, color:C.textMuted, marginBottom:12 }}>
                {lang==="de"?"Eigenkapital heute investiert":"Down payment invested today"}: <strong style={{ color:C.purple }}>{euro(reDownPayment)}</strong> ·
                {lang==="de"?" bei":"At"} {(annualReturn*100).toFixed(1)}%/{lang==="de"?"Jahr über":"yr over"} {reLoanTerm} {lang==="de"?"Jahre":"years"} = <strong style={{ color:C.cyan }}>{euro(Math.round(reDownPayment * Math.pow(1+annualReturn, reLoanTerm)))}</strong> {lang==="de"?"in ETFs":"in ETFs"}
              </div>
              <ResponsiveContainer width="100%" height={270}>
                <ComposedChart data={reBuyVsRentData} margin={{ left:0, right:10 }}>
                  ...
                  <YAxis tickFormatter={kilo} tick={{fill:C.textMuted,fontSize:10}} axisLine={false} tickLine={false} width={58} />
                  <Tooltip content={<CT/>} />
                  <ReferenceLine x={rePayoffYear} stroke={C.gold+"99"} strokeDasharray="4 2" label={{value:lang==="de"?"Abbezahlt":"Paid off",fill:C.gold,fontSize:9}} />
                  <Area type="monotone" dataKey={t.re.netWorthProp} stroke={rePropMode==="own"?C.gold:C.green} strokeWidth={2.5} fill="url(#propGrad)" dot={false} />
                  <Area type="monotone" dataKey={t.re.netWorthEtf} stroke={C.blue} strokeWidth={2} fill="url(#etfGrad2)" dot={false} strokeDasharray="6 3" />
                </ComposedChart>
              </ResponsiveContainer>
              {(() => {
                const yr30 = reBuyVsRentData[Math.min(30, reBuyVsRentData.length-1)];
                const propKey = t.re.netWorthProp;
                const etfKey = t.re.netWorthEtf;
                ...
                return (
                  <InfoBox color={propWins?C.gold:C.blue} style={{ marginTop:12 }}>
                    {propWins
                      ? (lang==="de"
                          ? `🏠 In Jahr 30 liegt Kaufen um ${euro(diff)} vorn — hauptsächlich durch ${reAppreciation}%/Jahr Wertsteigerung und erzwungenes Sparen via Eigenkapital.`
                      ...
                      : (lang==="de"
                          ? `📈 In Jahr 30 liegt ETF-Investieren um ${euro(diff)} vorn. Die ${(annualReturn*100).toFixed(1)}% ETF-Rendite übersteigt ${reAppreciation}% Wertsteigerung.`
                    ...
                    {" "}{lang==="de"?"Beide Strategien bauen erhebliches Vermögen auf. Eigentum bietet auch Sicherheit, Inflationsschutz und kein Vermieterrisiko.":"Both build substantial wealth. The real value of homeownership includes security, inflation protection, and no landlord risk."}
                  </InfoBox>
                );
              })()}
            </Card>
            ...
            {rePropMode === "own" && (
              <Card title={`🎯 ${t.re.fireImpact}`} accent={C.cyan}>
                <G2>
                  <div>
                    <G3>
                      <Box small label={t.re.fireImpactStandard} value={kilo(fireNum)} sub={`€${spending}/mo`} color={C.textSec} />
                      <Box small label={t.re.fireImpactBenefit} value={`-${euro(reHousingBenefit)}/mo`} sub={t.re.fireImpactBenefitSub} color={C.green} />
                      <Box small label={t.re.fireImpactAdj} value={kilo(reAdjustedFireNum)} sub={`€${reAdjustedSpending}/mo`} color={C.cyan} />
                      <Box small label={t.re.fireImpactStdYear} value={fireYear||"2040+"} color={C.textSec} />
                      <Box small label={t.re.fireImpactWithProp} value={reFireYearAdj||"2040+"} color={reFireYearAdj&&fireYear&&reFireYearAdj<fireYear?C.green:C.cyan} />
                      <Box small label={t.re.fireImpactDiff} value={reFireYearAdj&&fireYear?`${Math.abs(fireYear-(reFireYearAdj||fireYear))} ${lang==="de"?"J.":"yrs"} ${(reFireYearAdj||fireYear)<=fireYear?(lang==="de"?"früher":"earlier"):(lang==="de"?"später":"later")}`:"—"} color={(reFireYearAdj||999)<=(fireYear||999)?C.green:C.orange} />
                    </G3>
                  </div>
                  <div style={{ display:"flex", flexDirection:"column", gap:10 }}>
                    <InfoBox color={C.cyan}>
                      🏠 {lang==="de"
                        ? `Zwei-Phasen-Berechnung: Während der Kreditphase (${reLoanTerm} J.) sinken deine monatl. Ersparnisse um ${euro(Math.max(0, reMortgagePayment + reMaintenance - reCurrentRent))}/Mo. Nach Abbezahlung in ${rePayoffYear} sinken Wohnkosten auf nur ${euro(reMaintenance)}/Mo Instandhaltung — spart ${euro(reHousingBenefit)}/Mo dauerhaft und dein FIRE-Ziel sinkt von ${kilo(fireNum)} auf ${kilo(reAdjustedFireNum)}.`
                        : `Two-phase calculation: During the mortgage phase (${reLoanTerm} years), your monthly savings are reduced by ${euro(Math.max(0, reMortgagePayment + reMaintenance - reCurrentRent))}/mo. Once paid off in ${rePayoffYear}, housing cost drops to just ${euro(reMaintenance)}/mo maintenance, saving ${euro(reHousingBenefit)}/mo permanently — FIRE target drops from ${kilo(fireNum)} to ${kilo(reAdjustedFireNum)}.`}
                    </InfoBox>
                    <InfoBox color={C.orange}>
                      ⚠️ {lang==="de"
                        ? `Österr. Kaufnebenkosten: ~${euro(Math.round(rePropPrice*0.06))} einmalige Transaktionskosten: Grunderwerbsteuer (3,5%), Maklerprovision (~3%), Notarkosten (~1,5%).`
                        : `Austrian purchase costs: Factor in ~${euro(Math.round(rePropPrice*0.06))} in one-time transaction costs: Grunderwerbsteuer (3.5%), Maklerprovision (~3%), Notarkosten (~1.5%).`}
                    </InfoBox>
                  </div>
                </G2>
              </Card>
            ...
            {rePropMode === "invest" && (
              <Card title={t.re.btlTitle} accent={C.green}>
                <G3>
                  <Box small label={t.re.btlCashflowMo} value={`${reCashflow>=0?"+":""}${euro(reCashflow)}`} sub="/month" color={reCashflow>=0?C.green:C.red} />
                  <Box small label={t.re.btlCashflowYr} value={`${reCashflow>=0?"+":""}${euro(reCashflow*12)}`} sub="/year" color={reCashflow>=0?C.green:C.red} />
                  <Box small label={t.re.btlFireStd} value={fireYear||"2040+"} color={C.textSec} />
                  <Box small label={t.re.btlFireWith} value={reCashflow>0?(buildProj({start:startPort,monthlySavings:totalSavings+reCashflow,ret:annualReturn,years:40}).find(r=>r.portfolio>=fireNum)?.year||"2040+"):(fireYear||"2040+")} color={C.green} />
                  <Box small label={t.re.btlGross} value={`${reGrossYield.toFixed(1)}%`} sub="p.a." color={C.gold} />
                  <Box small label={t.re.btlNet} value={`${reNetYield.toFixed(1)}%`} sub={lang==="de"?"nach Steuer & Kosten":"after tax & costs"} color={reNetYield>=3?C.green:C.gold} />
                </G3>
                <div style={{ marginTop:12 }}>
                  <InfoBox color={C.green}>
                    💡 {lang==="de"
                      ? `Ein positiver Cashflow von ${euro(Math.max(0,reCashflow))}/Monat entspricht einer Erhöhung deiner monatlichen ETF-Sparrate um denselben Betrag. Über 20 Jahre bei ${(annualReturn*100).toFixed(1)}% Rendite kumuliert dieser Cashflow allein zu `
                      : `A positive cashflow of ${euro(Math.max(0,reCashflow))}/month is equivalent to increasing your monthly ETF savings by the same amount. Over 20 years at ${(annualReturn*100).toFixed(1)}% return, that extra cashflow alone compounds to `}
                    <strong>{kilo(Math.round(Math.max(0,reCashflow)*12*((Math.pow(1+annualReturn,20)-1)/annualReturn)))}</strong>
                    {lang==="de"?" an zusätzlichem Vermögen.":" in additional wealth."}
                  </InfoBox>
                </div>
              </Card>
            )}
        ...
        {tab === "roadmap" && (() => {
          ...
          const rePropLabel = reActiveMode === "own"
            ? `${euro(rePropPrice)} ${lang==="de"?"Eigenheim":"home"}`
            : reActiveMode === "build" ? `${lang==="de"?"Selbstbauprojekt":"self-build project"} (${euro(reBuildCost+reBuildLandCost)})`
            : reActiveMode === "inherit" ? (lang==="de"?"geerbte Immobilie":"inherited property")
            : reActiveMode === "invest" ? `${euro(rePropPrice)} ${lang==="de"?"Anlageimmobilie":"buy-to-let"}`
            : null;

          const narrative = lang==="de"
            ? `Du baust ein ${fireTypeName}-Leben auf. Du startest mit ${age} Jahren, ${euro(startPort)} investiert und ${euro(totalSavings)}/Monat Sparrate`
              + `${bonus13&&bonus14?" (inkl. 13. und 14. Gehalt)":bonus13?" (inkl. 13. Gehalt)":bonus14?" (inkl. 14. Gehalt)":""}. `
              + (lifestyleCreep > 0 ? `Lifestyle-Inflation von ${lifestyleCreep}%/Jahr ist eingerechnet. ` : "")
              + (coastDone ? "Du hast Coast FIRE bereits erreicht — dein Geld wächst von selbst. " : coastYear ? `Bis ${coastYear} (Alter ${coastYear-currentYear+age}) werden sich deine Investments selbst tragen. ` : "")
              + (reActiveMode === "none" ? `Du mietest (${euro(reCurrentRent)}/Mo) und investierst alle Ersparnisse in ETFs. ` : "")
              + (rePropLabel && reActiveMode !== "none" ? `Deine ${rePropLabel} ${reActiveMode==="inherit"?"kommt ohne Kaufkosten und ":""}ist bis ${rePayoffYear} vollständig bezahlt. ` : "")
              + (switchEnabled ? `In ${switchYear} wechselst du in Teilzeit — Zeit gewonnen, Vermögen wächst weiter. ` : "")
              + (ageAtFire ? `Volle Freiheit kommt in ${fireYear} mit Alter ${ageAtFire} — ${euro(spending)}/Monat, jeden Monat, für immer.` : "Volles FIRE ist am Horizont — weiter so.")
            : `You are building a ${fireTypeName} life. Starting at age ${age} with ${euro(startPort)} invested and ${euro(totalSavings)}/month going in`
              ...
              + (switchEnabled ? `In ${switchYear} you shift to part-time — reclaiming time while still growing wealth. ` : "")
          ...
          const wiNarrative = (whatIfNoHouse||whatIfEarlyRetire||whatIfNomad)
            ? `${[
                whatIfNoHouse&&(lang==="de"?"kein Eigentum (Anzahlung bleibt in ETFs)":"no property (down payment stays in ETFs)"),
                whatIfEarlyRetire&&(lang==="de"?"2 Jahre früher mit −10% Ausgaben":"retire 2 years earlier with −10% spending"),
                whatIfNomad&&(lang==="de"?"Nomad FIRE €700/Mo":"Nomad FIRE at €700/mo"),
              ].filter(Boolean).join(" · ")}. ${lang==="de"?"FIRE verschiebt sich auf":"FIRE shifts to"} ${wiFireYear||"2040+"} (${lang==="de"?"Alter":"age"} ${wiFireAge||"?"}).`
            : null;

          const timelineEvents = [
            { year:currentYear, icon:"📍", color:C.gold,
              title:t.roadmap.timeline.today,
              sub:`${lang==="de"?"Alter":"Age"} ${age} · ${euro(startPort)} ${lang==="de"?"investiert":"invested"} · ${lang==="de"?"spart":"saving"} ${euro(totalSavings)}/mo${lifestyleCreep>0?` · +${lifestyleCreep}%/yr ${lang==="de"?"Lifestyle-Inflation":"lifestyle creep"}`:""}`,
              tier:"now" },
            ...(reActiveMode === "own" ? [{ year:currentYear+1, icon:"🏠", color:C.orange,
              title:`${lang==="de"?"Immobilienkauf":"Home Purchase"} — ${euro(rePropPrice)}`,
              sub:`${reDownPct}% ${lang==="de"?"Eigenkapital":"down"} · ${euro(reMortgagePayment)}/mo ${lang==="de"?"Kredit":"mortgage"}`, tier:"major" }] : []),
            ...(reActiveMode === "build" ? [{ year:reBuildYear, icon:"🏗️", color:C.orange,
              title:`${lang==="de"?"Selbstbau fertig":"Self-Build Complete"} — ${euro(reBuildCost+reBuildLandCost)}`,
              sub:`${lang==="de"?"Grundstück + Bau":"Land + build"} · ${euro(reMortgagePayment)}/mo ${lang==="de"?"Kredit beginnt":"mortgage starts"}`, tier:"major" }] : []),
            ...(reActiveMode === "invest" ? [{ year:currentYear+1, icon:"💼", color:C.green,
              title:`${lang==="de"?"Anlagekauf":"Buy-to-Let Purchase"} — ${euro(rePropPrice)}`,
              sub:`${lang==="de"?"Bruttorendite":"Gross yield"} ${reGrossYield.toFixed(1)}% · cashflow ${reCashflow>=0?"+":""}${euro(reCashflow)}/mo`, tier:"major" }] : []),
            ...(reActiveMode === "inherit" ? [{ year:currentYear+3, icon:"🎁", color:C.purple,
              title:`${lang==="de"?"Erbschaft":"Property Inheritance"} — ${euro(reInheritedValue)}`,
              sub:lang==="de"?"Kein Kaufpreis. Nur Instandhaltung ab jetzt.":"No purchase cost. Maintenance only from this point.", tier:"major" }] : []),
            ...(coastYear ? [{ year:coastYear, icon:"🏖️", color:C.cyan,
              title:lang==="de"?"Coast FIRE erreicht":"Coast FIRE Achieved",
              sub:lang==="de"?"Portfolio trägt sich selbst bis zur Rente.":"Portfolio self-sustains to retirement. Could stop saving now.", tier:"fire" }] : []),
            ...(switchEnabled ? [{ year:switchYear, icon:"⚡", color:C.teal,
              title:`${lang==="de"?"Teilzeit-Wechsel":"Part-Time Switch"} — €${partTimeIncome}/mo`,
              sub:`${lang==="de"?"Mehr Leben, weniger Arbeit":"More life, less work"} · ${partTimeSavings>0?(lang==="de"?`noch sparend €${partTimeSavings}/mo`:`still saving €${partTimeSavings}/mo`):(lang==="de"?"aus Portfolio":"drawing from portfolio")}`, tier:"major" }] : []),
            ...(baristaYear ? [{ year:baristaYear, icon:"☕", color:C.coffeeGreen,
              title:"Barista FIRE",
              sub:`${lang==="de"?"Portfolio deckt":"Portfolio covers"} €${baristaGap}/mo ${lang==="de"?"Lücke. Teilzeit optional.":"gap. Part-time is now optional."}`, tier:"fire" }] : []),
            ...((reActiveMode==="own"||reActiveMode==="build") && rePayoffYear < 9999 ? [{ year:rePayoffYear, icon:"🔑", color:C.gold,
              title:lang==="de"?"Kreditfrei!":"Mortgage-Free!",
              sub:`${lang==="de"?"Wohnkosten sinken auf":"Housing cost drops to"} ${euro(reMaintenance)}/mo. ${lang==="de"?"Spart":"Saves"} ${euro(Math.max(0,reCurrentRent-reMaintenance))}/mo ${lang==="de"?"dauerhaft.":"forever."}`, tier:"major" }] : []),
            { year:(whatIfEarlyRetire?(wiFireYear||9999):(fireYear||9999)), icon:"🎯", color:C.gold,
              title:`${lang==="de"?"Volles":"Full"} ${fireTypeName} — ${lang==="de"?"Finanzielle Freiheit":"Financial Freedom"}`,
              sub:`${euro(whatIfEarlyRetire?wiSpending:spending)}/mo · ${kilo(whatIfEarlyRetire?wiFireNum:fireNum)} ${lang==="de"?"Portfolio":"portfolio"} · ${lang==="de"?"Alter":"Age"} ${whatIfEarlyRetire?wiFireAge:(fireYear?fireYear-currentYear+age:"?")}`, tier:"fire" },
            ...(travelBudget > 100 ? [{ year:(fireYear||currentYear+12)+1, icon:"✈️", color:C.teal,
              title:lang==="de"?"Das Reise-Kapitel beginnt":"The Travel Chapter Begins",
              sub:`${euro(travelBudget)}/mo ${lang==="de"?"Budget":"budget"} · ~${Math.round(travelAnnual/70)} ${lang==="de"?"Tage/Jahr":"days/year"}`, tier:"travel" }] : []),
          ].filter(e => e.year < 9998).sort((a,b) => a.year - b.year);

          const nextSteps = [
            !coastDone && { icon:"🚀", step:lang==="de"
              ? `Auf Coast FIRE (${kilo(coastTarget)}) hinarbeiten — du bist ${pct(startPort,coastTarget).toFixed(0)}% dort. Bei ${euro(totalSavings)}/Mo noch ~${Math.ceil(Math.max(0,coastTarget-startPort)/totalSavings)} Monate.`
              : `Build to Coast FIRE (${kilo(coastTarget)}) — you're ${pct(startPort,coastTarget).toFixed(0)}% there. At ${euro(totalSavings)}/mo, ~${Math.ceil(Math.max(0,coastTarget-startPort)/totalSavings)} months away.`, color:C.cyan },
            (reActiveMode === "own") && { icon:"🏗️", step:lang==="de"
              ? `${euro(reDownPayment)} Eigenkapital ansparen (${reDownPct}%). ETFs wachsen währenddessen weiter.`
              : `Save the ${euro(reDownPayment)} down payment (${reDownPct}%). Meanwhile your ETFs keep compounding.`, color:C.orange },
            (reActiveMode === "build") && { icon:"🏗️", step:lang==="de"
              ? `Grundstück sichern (${euro(reBuildLandCost)}) bis ${reBuildYear}. 10–15% Reserve auf Baukosten ${euro(reBuildCost)}.`
              : `Secure land (${euro(reBuildLandCost)}) before ${reBuildYear}. Budget 10–15% contingency on the ${euro(reBuildCost)} build cost.`, color:C.orange },
            (reActiveMode === "none") && { icon:"🏠", step:lang==="de"
              ? "Du mietest — öffne den Immobilien-Tab und modelliere einen Kauf um zu sehen ob er deinen FIRE-Termin verschiebt."
              : "You're renting — open the Real Estate tab and model a purchase to see whether buying would move your FIRE date.", color:C.gold },
            switchEnabled && { icon:"⚡", step:lang==="de"
              ? `12-Monats-Puffer (${euro(spending*12)}) vor Teilzeit-Wechsel ${switchYear} aufbauen.`
              : `Pre-fund your part-time switch in ${switchYear}: build a 12-month buffer (${euro(spending*12)}) before reducing income.`, color:C.teal },
            !taxRegelbest && { icon:"💰", step:lang==="de"
              ? "Regelbesteuerungsoption aktivieren sobald FIRE-Einkommen unter €13.539/Jahr fällt — möglicherweise 0% KESt auf Kapitalgewinne."
              : "Activate Regelbesteuerungsoption once FIRE income drops below €13,539/yr — potentially 0% KeSt on all capital gains.", color:C.gold },
            lifestyleCreep > 0 && { icon:"📈", step:lang==="de"
              ? `Lifestyle-Inflation von ${lifestyleCreep}%/Jahr aktiv — Projektions-Tab prüfen.`
              : `Lifestyle creep of ${lifestyleCreep}%/yr is active — check the Projection tab for timeline cost.`, color:C.pink },
            !switchEnabled && baristaYear && fireYear && fireYear-baristaYear > 2 && { icon:"☕", step:lang==="de"
              ? `Barista FIRE (${kilo(baristaTarget)}) erreichbar in ${baristaYear} — ${fireYear-baristaYear} Jahre vor vollem FIRE. Als Brücke erwägen.`
              : `Barista FIRE (${kilo(baristaTarget)}) is reachable in ${baristaYear} — ${fireYear-baristaYear} years before full FIRE. Consider it as a bridge.`, color:C.coffeeGreen },
          ].filter(Boolean).slice(0,3);

          return (
            <div>
              <div style={{ display:"flex", gap:4, marginBottom:18, background:C.surface, borderRadius:12, padding:4 }}>
                {[["roadmap",t.roadmap.subTabs.roadmap],["lab",t.roadmap.subTabs.lab]].map(([id,lbl]) => (
              ...
              {roadmapSubTab === "roadmap" && <div>
                <Card title={t.roadmap.lifeStory} accent={C.gold}>
                  <div style={{ fontSize:14, color:C.text, lineHeight:2.1, fontFamily:C.font, marginBottom:wiNarrative?14:0 }}>
                    {narrative.split(/(\d{4}|age \d+|Alter \d+|Coast FIRE|Barista FIRE|financial freedom|Finanzielle Freiheit)/gi).map((part, i) =>
                      /^(\d{4}|age \d+|Alter \d+|coast fire|barista fire|financial freedom|finanzielle freiheit)$/i.test(part)
                        ? <strong key={i} style={{ color:C.gold }}>{part}</strong>
                        : <span key={i}>{part}</span>
                    )}
                  </div>
                  {wiNarrative && <div style={{ background:C.purple+"15", border:`1px solid ${C.purple}44`, borderRadius:10, padding:"10px 14px", fontSize:13, color:C.purpleLight, lineHeight:1.7 }}>🔀 <strong>{lang==="de"?"Was wäre wenn:":"What-If:"}</strong> {wiNarrative}</div>}
                </Card>

                <Card title={t.roadmap.whatIf.title} accent={C.purple} titleRight={<Tip>{t.roadmap.whatIf.tip}</Tip>}>
                  <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(185px,1fr))", gap:10 }}>
                    {[
                      { key:"noHouse",     on:whatIfNoHouse,     set:setWhatIfNoHouse,     color:C.orange, icon:"🚫🏠",
                        title:t.roadmap.whatIf.noHouseTitle,
                        desc:rePropPrice>0?`${lang==="de"?"Hält":"Keep"} ${euro(reDownPayment)} ${lang==="de"?"in ETFs":"in ETFs instead"}`:(lang==="de"?"Kein Eigentum geplant":"No property planned") },
                      { key:"earlyRetire", on:whatIfEarlyRetire, set:setWhatIfEarlyRetire, color:C.green,  icon:"⏩",
                        title:t.roadmap.whatIf.earlyRetireTitle,
                        desc:`${t.roadmap.whatIf.earlyRetireDescPrefix} (${euro(Math.round(spending*0.9))}/mo ${t.roadmap.whatIf.earlyRetireDescInstead} ${euro(spending)})` },
                      { key:"nomad",       on:whatIfNomad,       set:setWhatIfNomad,       color:C.teal,   icon:"🌍",
                        title:t.roadmap.whatIf.nomadTitle,
                        desc:`${t.roadmap.whatIf.nomadDescPrefix} ${kilo(Math.round(700*12*legacyMult))}` },
                    ].map(opt => (
                      <div key={opt.key} onClick={() => opt.set(!opt.on)}
                        ...
                        <div style={{ fontSize:11, color:C.textMuted, lineHeight:1.6 }}>{opt.desc}</div>
                        {opt.on && <div style={{ marginTop:8, fontSize:12, fontWeight:700, color:opt.color }}>{t.roadmap.whatIf.fireLabel} {wiFireYear||"2040+"} · {t.roadmap.whatIf.ageLabel} {wiFireAge||"?"}</div>}
                      </div>
                    ))}
                  </div>
                  {(whatIfNoHouse||whatIfEarlyRetire||whatIfNomad) && (
                    <div style={{ marginTop:14 }}>
                      <G3>
                        <Box small label={t.roadmap.whatIf.wifFireYear} value={wiFireYear||"2040+"} sub={`${t.roadmap.whatIf.ageLabel} ${wiFireAge||"?"}`} color={C.purple} />
                        <Box small label={t.roadmap.whatIf.wifVsPlan} value={wiFireYear&&fireYear?`${Math.abs(wiFireYear-fireYear)} ${lang==="de"?"J.":"yrs"} ${wiFireYear<fireYear?t.roadmap.whatIf.earlier:t.roadmap.whatIf.later}`:"—"} color={wiFireYear&&fireYear&&wiFireYear<fireYear?C.green:C.orange} />
                        <Box small label={t.roadmap.whatIf.wifTarget} value={kilo(wiFireNum)} sub={`€${wiSpending}/mo`} color={C.purple} />
                      </G3>
                    </div>
                  )}
                </Card>

                <Card title={t.roadmap.timeline.title} accent={C.gold}>
                          ...
                          <div style={{ background:isFire?evt.color+"12":isNow?C.gold+"08":C.surface, border:`1px solid ${isFire?evt.color+"44":isNow?C.gold+"33":C.border}`, borderRadius:14, padding:"14px 16px" }}>
                            <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start", gap:8, flexWrap:"wrap" }}>
                              ...
                              <div style={{ textAlign:"right", flexShrink:0 }}>
                                ...
                                <div style={{ fontSize:10, color:C.textMuted }}>{lang==="de"?"Alter":"Age"} {evt.year-currentYear+age}</div>
                                {evt.year>currentYear && <div style={{ fontSize:10, color:C.textMuted }}>
                                  {(evt.year-currentYear)===1
                                    ? t.roadmap.timeline.inYr.replace("{n}",1)
                                    : t.roadmap.timeline.inYrs.replace("{n}",evt.year-currentYear)}
                                </div>}
                              </div>
                            </div>
                            {!isNow && (
                              <div style={{ marginTop:10 }}>
                                <div style={{ display:"flex", justifyContent:"space-between", marginBottom:3, fontSize:10, color:C.textMuted }}>
                                  <span>{t.roadmap.timeline.portfolioAt}</span>
                                ...
                                <div style={{ fontSize:9, color:C.textMuted, marginTop:2 }}>{pct(portAtYear,fireNum).toFixed(0)}% {t.roadmap.timeline.pctOfTarget} ({kilo(fireNum)})</div>
                              </div>
                            )}
                          </div>
                        </div>
                ...
                <Card title={t.roadmap.nextActions.title} accent={C.green} titleRight={<Tip>{t.roadmap.nextActions.tip}</Tip>}>
                  <div style={{ display:"flex", flexDirection:"column", gap:10 }}>
                    {nextSteps.map((s, i) => (
                      <div key={i} style={{ background:C.surface, border:`1px solid ${s.color}33`, borderRadius:12, padding:"14px 16px", display:"flex", gap:12, alignItems:"flex-start" }}>
                        ...
                        <div>
                          <div style={{ fontSize:10, color:s.color, fontWeight:700, marginBottom:3, textTransform:"uppercase", letterSpacing:1 }}>{t.roadmap.nextActions.actionLabel} {i+1}</div>
              ...
              {roadmapSubTab === "lab" && <div>
                <InfoBox color={C.purple}>{t.roadmap.lab.infoBox}</InfoBox>
                <div style={{ display:"flex", gap:10, margin:"14px 0", flexWrap:"wrap" }}>
                  <button onClick={() => {
                    if(snapshots.length >= 4) return;
                    const snap = {
                      id:Date.now(), label:`${lang==="de"?"Plan":"Plan"} ${snapshots.length+1}`,
                      spending, portfolio, fireYear, fireAge:fireYear?fireYear-currentYear+age:null,
                      fireTarget:fireNum, wealthAt90:Math.round(proj.find(r=>r.year>=currentYear+90-age)?.portfolio||0),
                      totalTax:Math.round((taxDragData[29]?.["Gross Portfolio"]||0)-(taxDragData[29]?.["Real Spendable"]||0)),
                      property:rePropMode, bonuses:bonus13||bonus14, lifestyle:lifestyleCreep,
                      taxStrategy:taxRegelbest?"Regelbesteuerung":taxHarvesting?"Harvesting":t.roadmap.lab.snapRows.standard,
                      partTime:switchEnabled, renting:rePropMode==="none", inherited:rePropMode==="inherit",
                      mode:spendMode,
                    };
                    setSnapshots([...snapshots, snap]);
                  }} disabled={snapshots.length>=4}
                    style={{ background:snapshots.length<4?C.gold:C.border, border:"none", borderRadius:10, padding:"10px 18px", cursor:snapshots.length<4?"pointer":"default", color:snapshots.length<4?"#000":C.textMuted, fontWeight:700, fontSize:13, fontFamily:C.font }}>
                    {t.roadmap.lab.saveBtn}
                  </button>
                  {snapshots.length > 0 && (
                    <button onClick={() => setSnapshots([])}
                      style={{ background:C.surface, border:`1px solid ${C.border}`, borderRadius:10, padding:"10px 18px", cursor:"pointer", color:C.textMuted, fontWeight:700, fontSize:13, fontFamily:C.font }}>
                      {t.roadmap.lab.clearBtn}
                    </button>
                  )}
                  <div style={{ fontSize:11, color:C.textMuted, alignSelf:"center" }}>
                    {t.roadmap.lab.snapshotsLabel.replace("{n}", snapshots.length)}
                  </div>
                </div>

                {snapshots.length === 0 && (
                  <div style={{ textAlign:"center", padding:"32px 16px", color:C.textMuted, fontSize:13 }}>
                    {t.roadmap.lab.emptyMsg}
                  </div>
                )}
                ...
                {snapshots.length >= 2 && (() => {
                  ...
                  const fireAgeDelta = (a.fireAge&&b.fireAge) ? b.fireAge - a.fireAge : null;
                  const wealthDelta = b.wealthAt90 - a.wealthAt90;
                  const taxDelta = b.totalTax - a.totalTax;
                  const analysis = fireAgeDelta === 0 && Math.abs(wealthDelta) < 5000
                    ? t.roadmap.lab.analysisDefault
                    : `${t.roadmap.lab.comparing} "${a.label}" vs "${b.label}". `
                      + (fireAgeDelta !== null ? `${t.roadmap.lab.diff.fireAgeDelta}: ${fireAgeDelta > 0 ? "+" : ""}${fireAgeDelta} ${lang==="de"?"Jahre":"yrs"}. ` : "")
                      + `${t.roadmap.lab.diff.wealthDelta}: ${wealthDelta > 0 ? "+" : ""}${kilo(wealthDelta)} (${b.label} ${wealthDelta > 0 ? t.roadmap.lab.diff.richer : lang==="de"?"ärmer":"poorer"}). `
                      + `${t.roadmap.lab.diff.taxDelta}: ${taxDelta > 0 ? "+" : ""}${kilo(taxDelta)} (${taxDelta < 0 ? b.label+" "+t.roadmap.lab.diff.savesMore : a.label+" "+t.roadmap.lab.diff.savesMore}).`;
                  return (
                    <Card title={t.roadmap.lab.analysisTitle} accent={C.purple}>
                      <div style={{ fontSize:13, color:C.textSec, lineHeight:1.9, marginBottom:14 }}>{analysis}</div>
                      <div style={{ fontSize:11, color:C.textMuted }}>{t.roadmap.lab.verdictLabel} {fireAgeDelta<0?`${b.label} ${lang==="de"?"erreicht FIRE":"reaches FIRE"} ${Math.abs(fireAgeDelta)} ${lang==="de"?"Jahre früher":"yrs earlier"}`:fireAgeDelta>0?`${a.label} ${lang==="de"?"erreicht FIRE":"reaches FIRE"} ${fireAgeDelta} ${lang==="de"?"Jahre früher":"yrs earlier"}`:`${t.roadmap.lab.diff.same} ${lang==="de"?"FIRE-Datum":"FIRE date"}`}</div>
                    </Card>
                  );
                })()}

                {snapshots.length >= 2 && (
                  <Card title={t.roadmap.lab.sideBySideTitle} accent={C.gold}>
                    <div style={{ overflowX:"auto" }}>
                      <table style={{ width:"100%", borderCollapse:"collapse", fontSize:12 }}>
                        <thead><tr style={{ background:C.surface }}>
                          <th style={{ padding:"8px 12px", textAlign:"left", color:C.textMuted, fontSize:10, textTransform:"uppercase" }}>{t.roadmap.lab.tableMetric}</th>
                          {snapshots.map(s => (
                            <th key={s.id} style={{ padding:"8px 12px", textAlign:"right", color:C.gold, fontSize:11 }}>{s.label}</th>
                          ))}
                          {snapshots.length >= 2 && <th style={{ padding:"8px 12px", textAlign:"right", color:C.purple, fontSize:10, textTransform:"uppercase" }}>{t.roadmap.lab.tableDelta}</th>}
                        </tr></thead>
                        <tbody>
                          {[
                            { key:"spending",  label:t.roadmap.lab.rows.spending,  fmt:s=>`€${s.spending}/mo` },
                            { key:"fireYear",  label:t.roadmap.lab.rows.fireYear,   fmt:s=>s.fireYear||"2040+" },
                            { key:"fireAge",   label:t.roadmap.lab.rows.fireAge,    fmt:s=>s.fireAge||"?" },
                            { key:"fireTarget",label:t.roadmap.lab.rows.fireTarget, fmt:s=>kilo(s.fireTarget) },
                            { key:"wealthAt90",label:t.roadmap.lab.rows.wealthAt90, fmt:s=>kilo(s.wealthAt90) },
                            { key:"totalTax",  label:t.roadmap.lab.rows.totalTax,   fmt:s=>kilo(s.totalTax) },
                            { key:"property",  label:t.roadmap.lab.rows.property,   fmt:s=>s.property||t.roadmap.lab.snapRows.none },
                            { key:"lifestyle", label:t.roadmap.lab.rows.lifestyle,  fmt:s=>s.lifestyle?`+${s.lifestyle}%/yr`:t.roadmap.lab.snapRows.none },
                            { key:"partTime",  label:t.roadmap.lab.rows.partTime,   fmt:s=>s.partTime?(lang==="de"?"Ja":"Yes"):t.roadmap.lab.snapRows.no },
                            { key:"tax",       label:t.roadmap.lab.rows.kv,         fmt:s=>s.taxStrategy||t.roadmap.lab.snapRows.standard },
                          ].map(row => {
                            const vals = snapshots.map(s => row.fmt(s));
                            const allSame = vals.every(v => v === vals[0]);
                            const a = snapshots[snapshots.length-2];
                            const b = snapshots[snapshots.length-1];
                            const delta = (row.key === "wealthAt90") ? kilo(b.wealthAt90-a.wealthAt90) :
                                          (row.key === "totalTax") ? kilo(b.totalTax-a.totalTax) :
                                          (row.key === "fireAge" && a.fireAge && b.fireAge) ? `${b.fireAge-a.fireAge > 0?"+":""}${b.fireAge-a.fireAge} ${lang==="de"?"J.":"yr"}` : "—";
                            return (
                              <tr key={row.key} style={{ borderBottom:`1px solid ${C.border}` }}>
                                <td style={{ padding:"8px 12px", color:C.textSec, fontSize:11 }}>{row.label}</td>
                                {vals.map((v,i) => (
                                  <td key={i} style={{ padding:"8px 12px", textAlign:"right", color:allSame?C.textMuted:C.text, fontFamily:C.mono, fontWeight:allSame?400:600 }}>{v}</td>
                                ))}
                                {snapshots.length >= 2 && <td style={{ padding:"8px 12px", textAlign:"right", color:C.purple, fontFamily:C.mono, fontSize:11 }}>{delta}</td>}
                              </tr>
                            );
                          })}
                        </tbody>
                ...
                {snapshots.length >= 2 && (
                  <Card title={t.roadmap.lab.netWorthTitle} accent={C.gold}>
                    <ResponsiveContainer width="100%" height={220}>
                      <LineChart data={Array.from({length:31},(_,i)=>{
                        const yr = currentYear+i;
                        const row = {year:yr};
                        snapshots.forEach(s => {
                          const p = buildProj({start:s.portfolio, monthlySavings:totalSavings, ret:annualReturn, years:31});
                          row[s.label] = p.find(r=>r.year>=yr)?.portfolio||0;
                        });
                        return row;
                      })} margin={{ left:0, right:10 }}>
                        <CartesianGrid strokeDasharray="3 3" stroke={C.border} />
                        <XAxis dataKey="year" tick={{fill:C.textMuted,fontSize:10}} axisLine={false} tickLine={false} />
                        <YAxis tickFormatter={kilo} tick={{fill:C.textMuted,fontSize:10}} axisLine={false} tickLine={false} width={54} />
                        <Tooltip content={<CT/>} />
                        {snapshots.map((s,i) => (
                          <Line key={s.id} dataKey={s.label} stroke={[C.gold,C.cyan,C.green,C.purple][i%4]} strokeWidth={2} dot={false} />
                        ))}
                      </LineChart>
                    </ResponsiveContainer>
                  </Card>
                ...
                {snapshots.length > 0 && snapshots.length < 2 && (
                  <InfoBox color={C.gold}>💡 {lang==="de"?"Ändere Einstellungen und speichere einen zweiten Snapshot um den Vergleich zu sehen.":"Change any settings and save a second snapshot to see the comparison."}</InfoBox>
                )}
              </div>}
    ...
    <div style={{ background:C.card, border:`1px solid ${open?color+"44":C.border}`, borderRadius:10, overflow:"hidden", marginBottom:8, transition:"border-color 0.15s" }}>
      <button onClick={() => setOpen(!open)} style={{ width:"100%", background:"none", border:"none", cursor:"pointer", display:"flex", alignItems:"center", justifyContent:"space-between", padding:"12px 16px", fontFamily:C.font, textAlign:"left" }}>
        <div style={{ display:"flex", alignItems:"center", gap:8, flex:1 }}>
          {urgent && <span style={{ background:C.gold, color:"#000", fontSize:8, fontWeight:800, padding:"2px 6px", borderRadius:4, letterSpacing:1, whiteSpace:"nowrap" }}>⚑</span>}
